...
| `state_yN_0_yF_p0p05` | `clarity_improvement` | -0.0217 | 0.0133 | 0.7000 | 0.0000 | True |
| `state_yN_m0p05_yF_0` | `nutrient_reduction_tp` | -0.0367 | 0.0133 | 1.0000 | 0.0000 | False |
| `state_yN_m0p025_yF_p0p025` | `combined_nutrient_clarity` | -0.0392 | 0.0133 | 1.0500 | 0.0000 | False |
| `state_yN_0_yF_p0p1` | `clarity_improvement` | -0.0435 | 0.0265 | 1.4000 | 0.0000 | True |
| `state_yN_m0p025_yF_p0p05` | `combined_nutrient_clarity` | -0.0500 | 0.0200 | 1.4000 | 0.0000 | False |
| `state_yN_m0p05_yF_p0p025` | `combined_nutrient_clarity` | -0.0575 | 0.0200 | 1.5500 | 0.0000 | False |
| `state_yN_m0p05_yF_p0p05` | `combined_nutrient_clarity` | -0.0683 | 0.0267 | 1.9000 | 0.0000 | True |
