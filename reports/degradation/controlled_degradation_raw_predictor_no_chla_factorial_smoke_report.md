...
Generated at UTC: `2026-06-12T18:23:58.864044+00:00`
Started at UTC: `2026-06-12T18:20:39.670398+00:00`
...
| `ablate_chlorophyll_memory_and_nutrients` | `x_irc_basis` | 5,490 | 5,313 | 0.4024 | 0.5253 | 0.1229 | 0.2365 |
| `ablate_chlorophyll_memory_and_nutrients` | `x_yF` | 5,490 | 0 | 0.5443 | 0.5443 | 0.0000 | 0.0000 |
| `ablate_chlorophyll_memory_and_nutrients` | `x_yN` | 5,490 | 2,097 | 0.5017 | 0.5000 | -0.0017 | 0.1078 |
| `ablate_chlorophyll_memory_and_nutrients` | `x_yT` | 5,490 | 4,857 | 0.3642 | 0.5490 | 0.1848 | 0.3354 |
...
| `ablate_chlorophyll_memory_and_nutrients` | `evaluated` | NA | 28,299,004 | 5,236,190 | 19,185 | 1,536 | 72 |
...
| `ablate_chlorophyll_memory_and_nutrients` | NA | `test` | 1 | `all` | 4,608 | 0.2461 | 0.2634 | 0.0655 | 0.1447 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `test` | 1 | `irc1` | 512 | 0.2694 | 0.2860 | 0.0577 | 0.2396 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `test` | 2 | `all` | 4,608 | 0.2447 | 0.2659 | 0.0797 | 0.1455 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `test` | 2 | `irc1` | 512 | 0.2676 | 0.2981 | 0.1022 | 0.2406 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `test` | 3 | `all` | 4,608 | 0.2424 | 0.2714 | 0.1071 | 0.1458 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `test` | 3 | `irc1` | 512 | 0.2634 | 0.3094 | 0.1487 | 0.2344 |
...
| `ablate_chlorophyll_memory_and_nutrients` | NA | `bloom_h` | `test` | 1 | 461 | 0.1302 | 0.0174 | 0.1971 | 0.1123 | 0.0333 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `bloom_h` | `test` | 2 | 460 | 0.1348 | 0.0087 | 0.2147 | 0.1141 | 0.0161 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `bloom_h` | `test` | 3 | 467 | 0.1328 | 0.0043 | 0.2156 | 0.1116 | 0.0161 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `irc_alert` | `test` | 1 | 512 | 0.3379 | 0.3711 | 0.4085 | 0.3574 | 0.5202 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `irc_alert` | `test` | 2 | 512 | 0.3477 | 0.2891 | 0.4343 | 0.3242 | 0.4494 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `irc_alert` | `test` | 3 | 512 | 0.3535 | 0.2773 | 0.4980 | 0.2754 | 0.5028 |
...
| `ablate_chlorophyll_memory_and_nutrients` | NA | `closest_pr` | `bloom_h` | `test` | 1 | 461 | 0.1667 | 0.2326 | 0.0933 | 0.1767 | -0.5096 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `closest_pr` | `bloom_h` | `test` | 2 | 460 | 0.2581 | 0.2540 | 0.1370 | 0.2572 | -0.4527 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `closest_pr` | `bloom_h` | `test` | 3 | 467 | 0.3387 | 0.2360 | 0.1906 | 0.3116 | -0.3609 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `closest_pr` | `irc_alert` | `test` | 1 | 512 | 0.5202 | 0.4737 | 0.3711 | 0.5102 | -0.2288 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `closest_pr` | `irc_alert` | `test` | 2 | 512 | 0.4494 | 0.5405 | 0.2891 | 0.4651 | -0.2078 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `closest_pr` | `irc_alert` | `test` | 3 | 512 | 0.5028 | 0.6408 | 0.2773 | 0.5254 | -0.1120 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `fbeta` | `bloom_h` | `test` | 1 | 461 | 0.3000 | 0.2368 | 0.1649 | 0.2848 | -0.4710 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `fbeta` | `bloom_h` | `test` | 2 | 460 | 0.4355 | 0.2231 | 0.2630 | 0.3659 | -0.3425 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `fbeta` | `bloom_h` | `test` | 3 | 467 | 0.9355 | 0.1616 | 0.7687 | 0.4778 | -0.2220 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `fbeta` | `irc_alert` | `test` | 1 | 512 | 0.5202 | 0.4737 | 0.3711 | 0.5102 | -0.2288 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `fbeta` | `irc_alert` | `test` | 2 | 512 | 0.4494 | 0.5405 | 0.2891 | 0.4651 | -0.2078 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `fbeta` | `irc_alert` | `test` | 3 | 512 | 0.5028 | 0.6408 | 0.2773 | 0.5254 | -0.1120 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `fixed` | `bloom_h` | `test` | 1 | 461 | 0.0333 | 0.2500 | 0.0174 | 0.0403 | -0.4633 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `fixed` | `bloom_h` | `test` | 2 | 460 | 0.0161 | 0.2500 | 0.0087 | 0.0198 | -0.3816 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `fixed` | `bloom_h` | `test` | 3 | 467 | 0.0161 | 0.5000 | 0.0043 | 0.0200 | -0.2937 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `fixed` | `irc_alert` | `test` | 1 | 512 | 0.5202 | 0.4737 | 0.3711 | 0.5102 | -0.2288 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `fixed` | `irc_alert` | `test` | 2 | 512 | 0.4494 | 0.5405 | 0.2891 | 0.4651 | -0.2078 |
| `ablate_chlorophyll_memory_and_nutrients` | NA | `fixed` | `irc_alert` | `test` | 3 | 512 | 0.5028 | 0.6408 | 0.2773 | 0.5254 | -0.1120 |
...
- State metrics: `reports/degradation/controlled_degradation_raw_predictor_no_chla_factorial_smoke_state_metrics.csv`
- Alert metrics: `reports/degradation/controlled_degradation_raw_predictor_no_chla_factorial_smoke_alert_metrics.csv`
- Policy metrics: `reports/degradation/controlled_degradation_raw_predictor_no_chla_factorial_smoke_policy_metrics.csv`
- Summary: `reports/degradation/controlled_degradation_raw_predictor_no_chla_factorial_smoke_summary.csv`
- Examples: `reports/degradation/controlled_degradation_raw_predictor_no_chla_factorial_smoke_examples.csv`
- Diagnostics: `reports/degradation/controlled_degradation_raw_predictor_no_chla_factorial_smoke_diagnostics.csv`
- Backtest rows: `None`
- Manifest: `reports/degradation/controlled_degradation_raw_predictor_no_chla_factorial_smoke_manifest.json`
