...
unconditionally guarded by the published additive E0-MK P1/20260613 consumer
...
def main() -> None:
    ...
    from src.experiments.closure_p1_temporal_consumer_seed_20260613_patch import (
