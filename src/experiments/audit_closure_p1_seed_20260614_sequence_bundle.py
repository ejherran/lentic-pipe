#!/usr/bin/env python
"""Reopen and audit the immutable Closure V1 P1 seed 20260614 sequence bundle."""
...
PRIOR_P1_PATHS = (*P1_1729_PATHS, *P1_20260612_PATHS, *P1_20260613_PATHS)
LATER_P1_PATHS = tuple(
    path
    for seed in REGISTERED_BASE_SEEDS
    if seed not in {1729, 20260612, 20260613, BASE_SEED}
...
EXPECTED_INPUT_RECORDS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "bytes": 20_886,
        "sha256": "04d8dd355acd813656a0b3fd99123f095db7aa9ca7181f195e1e047214417946",
    },
    {
        "path": E0_ML_LOCK_PATH.as_posix(),
        "bytes": 31_537,
        "sha256": "e8f111bdfb3761ff23faaeff15bfc01454bdc5e1659fccb02d43d2a3d89a25c1",
    },
    {
        "path": E0_ML_COMPANION_PATH.as_posix(),
        "bytes": 9_256,
    ...
    },
    {
        ...
        "bytes": 1_214_501,
        "sha256": "58aff087072fabae30afb7fa01b474fb2ba1c7dd1958e7ed8e9d1a19d989ead9",
    },
)
...
EXPECTED_E0_ML_INPUT_RECORDS: tuple[dict[str, Any], ...] = (
    {
        "bytes": 19340,
        "path": "configs/closure_v1/p1_sequence_seed_20260614_patch_lock.schema.json",
        "role": "p1_sequence_seed_20260614_patch_lock_schema",
        "sha256": "904b441c44729fed7b76246143b2ea80fc264b09b297e7a6861701322b112662"
    },
    {
        "bytes": 1214501,
        "path": "data/closure_v1/development/anfis/seed_20260614/adaptive_no_current_state.parquet",
        "role": "anfis_20260614_state_parquet",
        "sha256": "58aff087072fabae30afb7fa01b474fb2ba1c7dd1958e7ed8e9d1a19d989ead9"
    },
    {
        "bytes": 116,
        "path": "data/closure_v1/development/anfis/seed_20260614/adaptive_no_current_state.parquet.dvc",
        "role": "anfis_20260614_state_pointer",
        "sha256": "e6e402593a26760270558bf24b9b03963b238f5b5f0d21572066c6c7b4f84f04"
    },
    {
        "bytes": 1380222,
        "path": "data/closure_v1/development/sequences/P1/seed_1729.parquet",
    ...
    {
        "bytes": 28541,
        "path": "reports/closure_v1/00_protocol/p1_sequence_seed_20260613_patch_lock.json",
    ...
    {
        "bytes": 7835,
        "path": "reports/closure_v1/00_protocol/p1_sequence_seed_20260613_patch_lock_manifest.json",
        "role": "p1_sequence_seed_20260613_patch_companion",
        "sha256": "81a02be5697e39ec26a04a28c52345d02871946974f5b070809518aa2f371d63"
    },
    {
        "bytes": 38928,
        "path": "reports/closure_v1/00_protocol/p1_temporal_consumer_seed_20260613_patch_lock.json",
        "role": "external_p1_temporal_consumer_seed_20260613_patch_lock",
        "sha256": "222412b6e18381fff9e21b1b67100dfcd480ed61042c50639317fad2b3b9974b"
    },
    {
        "bytes": 8849,
        "path": "reports/closure_v1/00_protocol/p1_temporal_consumer_seed_20260613_patch_lock_manifest.json",
        "role": "p1_temporal_consumer_seed_20260613_patch_companion",
        "sha256": "9f4e7c8aba4aed3ec89a69f86db2273beda70c029636ae29af00ffdaa4430c87"
    },
    {
        "bytes": 20886,
        "path": "reports/closure_v1/01_surface/anfis/seed_20260614/manifest.json",
    ...
    {
        "bytes": 88061,
        "path": "src/experiments/closure_p1_sequence_seed_20260614_patch.py",
        "role": "p1_sequence_seed_20260614_patch_validator",
        "sha256": "e0ca05353e980534686fb0555ffca0c776d255b3c01d8c4acbf8c56dc156a3bc"
    },
)

EXPECTED_E0_ML_PATCH_RECORDS: tuple[dict[str, Any], ...] = (
    {
        "bytes": 19340,
        "path": "configs/closure_v1/p1_sequence_seed_20260614_patch_lock.schema.json",
        "role": "p1_sequence_seed_20260614_patch_lock_schema",
    ...
    {
        "bytes": 4141,
        "path": "docs/closure_v1/E0_M_P1_SEQUENCE_SEED_20260614_PATCH_1.md",
        "role": "p1_sequence_seed_20260614_patch_protocol",
        "sha256": "1993220179285cb6bd5efc4324da893d080daf3a3534e22d144e8b391eafd313"
    },
    {
        "bytes": 127863,
        "path": "src/experiments/build_closure_pipe_sequences.py",
    ...
    {
        "bytes": 36170,
        "path": "src/experiments/lock_closure_p1_sequence_seed_20260614_patch.py",
        "role": "p1_sequence_seed_20260614_patch_locker",
        "sha256": "32b68ab6033d2b49c06aa4677f4e99c047aab4ca54246b3d376fdb2290915819"
    },
    {
        "bytes": 76105,
    ...
    {
        "bytes": 38576,
        "path": "tests/test_closure_p1_sequence_seed_20260614_patch.py",
        "role": "p1_sequence_seed_20260614_patch_tests",
        "sha256": "35f031b5d9c5cfa1c262ff3a4e5565f474a79efc39533892496c324a4727984a"
    },
)
...
EXPECTED_HISTORICAL_INPUTS: tuple[dict[str, Any], ...] = (
    {
        "bytes": 127846,
        "commit": "3b86b75edcfa5d11eab6bb97ab7cfd71df468fab",
...
class ClosureP1Seed20260614SequenceAuditError(ValueError):
    """Raised when the physical P1/20260614 bundle differs from closed evidence."""
...
def _decode_strict_json(payload_bytes: bytes, *, path: str) -> dict[str, Any]:
    def reject_constant(value: str) -> None:
        raise ClosureP1Seed20260614SequenceAuditError(
...
def _closed_paths(*, pointer_present: bool) -> tuple[Path, ...]:
    candidates = (
        ...
        *(Path(str(record["path"])) for record in EXPECTED_E0_ML_INPUT_RECORDS),
        *(Path(str(record["path"])) for record in EXPECTED_E0_ML_PATCH_RECORDS),
...
def _validate_closed_namespace(snapshot: Mapping[str, Any]) -> dict[str, Any]:
    if set(snapshot) != set(NAMESPACE_DIRECTORIES):
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 namespace snapshot dialect drifted"
        )
    entries = {
    ...
    if missing_required:
        raise ClosureP1Seed20260614SequenceAuditError(
            f"P1/20260614 sequence bundle is incomplete: {missing_required}"
        )
    ...
    if forbidden_sequence:
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 bundle has temporary or guard state: "
    ...
    return {
        ...
        "progression_observation": {
            ...
            "prior_seeds": [1729, 20260612, 20260613],
...
def _require_pre_consumer_progression_clear(
    ...
    if not isinstance(progression, Mapping) or (
        ...
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 pre-consumer CLI gate requires its consumer, later P1, "
...
def _validate_dvc_pointer(sequence: Any, pointer: Any | None) -> dict[str, Any]:
    ...
    if match is None:
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 explicit DVC pointer dialect drifted"
        )
    ...
    if observed_md5 != expected_md5 or observed_size != len(sequence.payload):
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 DVC pointer does not bind the physical Parquet"
        )
    return {
        "state": "post_dvc",
...
def _load_assignment(payload: bytes) -> pd.DataFrame:
    try:
        ...
        raise ClosureP1Seed20260614SequenceAuditError(str(exc)) from exc
...
def _validate_physical_schema(schema: pa.Schema) -> None:
    if schema.names != list(SEQUENCE_COLUMNS):
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 Parquet columns/order drifted"
        )
    for column in SEQUENCE_COLUMNS:
        ...
        if not valid:
            raise ClosureP1Seed20260614SequenceAuditError(
                f"P1/20260614 physical schema drifted: {column}"
            )
...
def _validate_physical_payload(table: pa.Table) -> dict[str, int]:
    ...
    if bool((reasons[success] != "").any()) or (
        ...
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 physical failure reasons drifted"
        )
    ...
    if observed_roles != EXPECTED_ROLE_COUNTS:
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 physical role counts drifted"
        )
    ...
    for column in INPUT_COLUMNS:
        ...
        if values.null_count:
            raise ClosureP1Seed20260614SequenceAuditError(
                f"P1/20260614 input list parents must remain valid: {column}"
            )
        ...
        if bool(child_null[success].any()) or (
            ...
            raise ClosureP1Seed20260614SequenceAuditError(
                f"P1/20260614 input null policy drifted: {column}"
            )
        ...
        if not bool(np.isfinite(child_values[success]).all()):
            raise ClosureP1Seed20260614SequenceAuditError(
                f"P1/20260614 successful input is non-finite: {column}"
            )
    ...
    for column in TARGET_COLUMNS:
        ...
        if bool(nulls[success].any()) or (
            ...
            raise ClosureP1Seed20260614SequenceAuditError(
                f"P1/20260614 target null policy drifted: {column}"
            )
        successful = [
            value
        ...
        if not bool(np.isfinite(np.asarray(successful, dtype=np.float64)).all()):
            raise ClosureP1Seed20260614SequenceAuditError(
                f"P1/20260614 successful target is non-finite: {column}"
            )
    ...
    *,
    ...
    for field, value in expected.items():
        if not _typed_equal(payload.get(field), value):
            raise ClosureP1Seed20260614SequenceAuditError(
                f"P1/20260614 state manifest field drifted: {field}"
            )
    ...
    if matches != [{**dict(state_record), "role": "adaptive_no_current_state"}]:
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 state manifest does not bind its adaptive state"
        )


def _validate_e0_ml_reference(
    ...
    *,
    ...
    if lock_digest != EXPECTED_INPUT_RECORDS[10]["sha256"]:
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML canonical lock payload drifted"
        )
    if companion_digest != EXPECTED_INPUT_RECORDS[11]["sha256"]:
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML canonical companion payload drifted"
        )
    ...
    for field, value in expected_lock_identity.items():
        if not _typed_equal(lock.get(field), value):
            raise ClosureP1Seed20260614SequenceAuditError(
                f"E0-ML lock identity drifted: {field}"
            )
    ...
    if not _typed_equal(lock.get("authorizations"), expected_authorizations):
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML authorization seals drifted"
        )
    ...
    expected_repository = {
        ...
        "head": E0_ML_H_COMMIT,
        "parent": "fea057b808e2e454c47da1256a5ec8f68dd9bb80",
        "published_head": E0_ML_H_COMMIT,
        "published_ref": "origin/main",
        "remote_main_oid": E0_ML_H_COMMIT,
        "worktree_status": "clean",
    }
    if not _typed_equal(lock.get("patch_repository"), expected_repository):
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML publication topology seal drifted"
        )

    for expected in (*EXPECTED_E0_ML_INPUT_RECORDS, *EXPECTED_E0_ML_PATCH_RECORDS):
        path = str(expected["path"])
        observed = physical_records.get(path)
        if observed is None or not _typed_equal(dict(observed), _physical_record(expected)):
            raise ClosureP1Seed20260614SequenceAuditError(
                f"E0-ML physical record drifted: {path}"
            )
    expected_builder = {
    ...
    if not _typed_equal(lock.get("current_runtime_builder_record"), expected_builder):
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML current builder binding drifted"
        )

    expected_anfis = {
        "fit_status": "passed",
        "future_outcomes_accessed": False,
        "publication_commit": "929e7da1a8f9afeedde588685ec0adb311345bc2",
        "records": [
            dict(EXPECTED_E0_ML_INPUT_RECORDS[index]) for index in (1, 2, 13)
        ],
        "records_sha256": "297abe112a6230c24d1c1a21994417a7484538c10b60a663d8a900431827fdb3",
        "slot_status": "available",
        "state_manifest_verified": True,
    }
    if not _typed_equal(lock.get("anfis_20260614_state_bundle"), expected_anfis):
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML ANFIS 20260614 binding drifted"
        )
    ...
    if not isinstance(prior, Mapping) or not _typed_equal(
        ...
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML predecessor P1/1729 records drifted"
        )
    ...
    if any(not _typed_equal(prior.get(key), value) for key, value in expected_prior_fields.items()):
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML predecessor P1/1729 semantic seals drifted"
        )
    ...
    if not isinstance(prior_20260612, Mapping) or not _typed_equal(
        ...
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML predecessor P1/20260612 records drifted"
        )
    ...
    if any(
        ...
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML predecessor P1/20260612 semantic seals drifted"
        )
    ...
    if not isinstance(prior_20260613, Mapping) or not _typed_equal(
        ...
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML predecessor P1/20260613 records drifted"
        )
    ...
    if any(
        ...
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML predecessor P1/20260613 semantic seals drifted"
        )

    components = lock.get("patch_components")
    if not isinstance(components, Mapping) or not _typed_equal(
        components.get("records"), [dict(record) for record in EXPECTED_E0_ML_PATCH_RECORDS]
    ):
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML patch component bindings drifted"
        )
    if components.get("count") != len(EXPECTED_E0_ML_PATCH_RECORDS):
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML patch component count drifted"
        )
    ...
    if not isinstance(sequence_prelock, Mapping) or any(
        ...
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML target namespace prelock seal drifted"
        )
    expected_seals = {
    ...
    if not _typed_equal(lock.get("seals"), expected_seals):
        raise ClosureP1Seed20260614SequenceAuditError("E0-ML scientific seals drifted")
    expected_atomicity = {
    ...
    if not _typed_equal(lock.get("sequence_atomicity"), expected_atomicity):
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML sequence atomicity contract drifted"
        )
    ...
    expected_companion_identity = {
        ...
        "authoritative_lock_path": E0_ML_LOCK_PATH.as_posix(),
        "authorized_model_id": MODEL_ID,
        "authorized_base_seed": BASE_SEED,
        "batch_seed_execution_authorized": False,
        "dvc_commands_authorized": False,
    ...
    for field, value in expected_companion_identity.items():
        if not _typed_equal(companion.get(field), value):
            raise ClosureP1Seed20260614SequenceAuditError(
                f"E0-ML companion identity drifted: {field}"
            )
    if not _typed_equal(
        companion.get("inputs"), [dict(record) for record in EXPECTED_E0_ML_INPUT_RECORDS]
    ):
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML companion physical inputs drifted"
        )
    if not _typed_equal(
        ...
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML companion historical inputs drifted"
        )
    expected_script = {
        **_physical_record(EXPECTED_E0_ML_PATCH_RECORDS[4]),
        "role": "generating_script",
    }
    if not _typed_equal(companion.get("script"), expected_script):
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML companion script binding drifted"
        )
    expected_output = {
        **dict(lock_record),
    ...
    if not _typed_equal(companion.get("outputs"), [expected_output]):
        raise ClosureP1Seed20260614SequenceAuditError(
            "E0-ML companion lock binding drifted"
        )
    return {
        ...
        "physical_input_count": len(EXPECTED_E0_ML_INPUT_RECORDS),
        "physical_patch_component_count": len(EXPECTED_E0_ML_PATCH_RECORDS),
        "historical_inputs_compared_to_current_paths": False,
...
def _validate_manifest(
    ...
    *,
    ...
    if set(payload) != MANIFEST_KEYS:
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 manifest top-level dialect drifted"
        )
    expected_identity = {
    ...
    for field, value in expected_identity.items():
        if not _typed_equal(payload.get(field), value):
            raise ClosureP1Seed20260614SequenceAuditError(
                f"P1/20260614 manifest field drifted: {field}"
            )
    generated_at = payload.get("generated_at_utc")
    if not isinstance(generated_at, str):
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 manifest timestamp is absent"
        )
    try:
        parsed = datetime.fromisoformat(generated_at)
    except ValueError as exc:
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 manifest timestamp is invalid"
        ) from exc
    if parsed.tzinfo is None:
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 manifest timestamp must be timezone-aware"
        )
    ...
    for field, expected in exact_sections.items():
        if not _typed_equal(payload.get(field), expected):
            raise ClosureP1Seed20260614SequenceAuditError(
                f"P1/20260614 manifest section drifted: {field}"
            )
    counts = payload.get("counts")
    if not isinstance(counts, Mapping) or set(counts) != MANIFEST_COUNT_KEYS:
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 manifest count dialect drifted"
        )
    if not _typed_equal(dict(counts), _manifest_counts(audit, boundary)):
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 manifest counts differ from reconstruction"
        )
...
def _manifest_last_evidence(manifest: Mapping[str, Any]) -> dict[str, Any]:
    if manifest.get("completion_marker_written_last") is not True:
        raise ClosureP1Seed20260614SequenceAuditError(
            "P1/20260614 completion marker seal drifted"
        )
    return {
        "publication_order": [
            P1_SEQUENCE_PATH.as_posix(),
        ...
        "e0_ml_atomicity_contract_reconciled": True,
...
def _audit_p1_seed_20260614_sequence_bundle() -> dict[str, Any]:
    result: dict[str, Any]
    with historical.secure_reads._RepoReadSession(PROJECT_ROOT) as session:
        ...
        ml_lock_file = file_for(E0_ML_LOCK_PATH)
        ml_companion_file = file_for(E0_ML_COMPANION_PATH)
        ml_lock = _decode_strict_json(
            ml_lock_file.payload,
            path=E0_ML_LOCK_PATH.as_posix(),
        )
        ml_companion = _decode_strict_json(
            ml_companion_file.payload,
            path=E0_ML_COMPANION_PATH.as_posix(),
        )
        _assert_canonical_json(
            ml_lock_file.payload,
        ...
        e0_ml = _validate_e0_ml_reference(
            ml_lock,
            ml_companion,
            lock_record=ml_lock_file.record,
            physical_records=e0_ml_physical_records,
        )
        ...
        if build_audit.role_counts != EXPECTED_ROLE_COUNTS:
            raise ClosureP1Seed20260614SequenceAuditError(
                "P1/20260614 reconstructed role counts drifted"
            )
        if build_audit.status_counts != EXPECTED_STATUS_COUNTS:
            raise ClosureP1Seed20260614SequenceAuditError(
                "P1/20260614 reconstructed status counts drifted"
            )
        if build_audit.failure_reason_counts != EXPECTED_FAILURE_REASON_COUNTS:
            raise ClosureP1Seed20260614SequenceAuditError(
                "P1/20260614 reconstructed failure reasons drifted"
            )
        if (
            ...
            raise ClosureP1Seed20260614SequenceAuditError(
                "P1/20260614 reconstructed delta audit drifted"
            )
        ...
        if physical_schema.names != list(SEQUENCE_COLUMNS):
            raise ClosureP1Seed20260614SequenceAuditError(
                "P1/20260614 Parquet schema has extra or reordered columns"
            )
        ...
        if differing_columns or actual_table.num_rows != expected_table.num_rows:
            raise ClosureP1Seed20260614SequenceAuditError(
                "P1/20260614 rows differ from sealed reconstruction: "
        ...
        if physical != expected_physical:
            raise ClosureP1Seed20260614SequenceAuditError(
                "P1/20260614 physical null evidence drifted"
            )
        ...
        if summary_file.payload != _summary_bytes(expected_frame):
            raise ClosureP1Seed20260614SequenceAuditError(
                "P1/20260614 summary bytes differ from reconstruction"
            )
        ...
        if namespace_before != namespace_after:
            raise ClosureP1Seed20260614SequenceAuditError(
                "P1/20260614 audit namespace changed during readback"
            )
...
def audit_p1_seed_20260614_sequence_bundle() -> dict[str, Any]:
    """Audit the closed P1/20260614 bundle without mutating repository state."""
    try:
        return _audit_p1_seed_20260614_sequence_bundle()
    except ClosureP1Seed20260614SequenceAuditError:
        raise
    except historical.ClosureP1SequenceAuditError as exc:
        raise ClosureP1Seed20260614SequenceAuditError(str(exc)) from exc
    except historical.secure_reads.ClosureP0SequenceAuditError as exc:
        raise ClosureP1Seed20260614SequenceAuditError(
            str(exc).replace("P0", "P1/20260614")
        ) from exc
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Read-only audit of the closed Closure V1 P1/20260614 sequence bundle."
        )
    )
    parser.add_argument(
        CHECK_ONLY_FLAG,
        action="store_true",
        required=True,
        help="Reopen and validate the fixed P1/20260614 bundle without writing outputs.",
    )
...
def main(argv: Sequence[str] | None = None) -> None:
    parse_args(argv)
    try:
        result = audit_p1_seed_20260614_sequence_bundle()
