#!/usr/bin/env python
"""Validate the additive Closure V1 P1/314159 sequence authority.

E0-MN is a builder-only successor to the published P1/20260614 unavailable
consumer evidence.  It reconstructs E0-ML and E0-MM from immutable Git
history, preserves the four complete P1 sequence+consumer bundles through
seed 20260614, binds ANFIS state for seed 314159, and authorizes one future P1
sequence build for seed 314159.  It never authorizes training, evaluation,
E0-M, E0-U, DVC mutation, or outcome access.
"""
...
from src.experiments import closure_p1_sequence_seed_20260614_patch as e0_ml
from src.experiments import closure_p1_temporal_consumer_seed_20260614_patch as e0_mm
...
E0_ML_H_COMMIT = "b30bf68caaee84af2b477ecc36a35fdb2d1cd076"
E0_ML_P_COMMIT = "fa18ac0e8542ac41ab8bb9413fe085ac0e5f2bca"
E0_MM_H_COMMIT = "f6cd0bfeaddf9a393588924072fab93e89e739db"
E0_MM_P_COMMIT = "e216bf4f080d98895aa52d18c0f278ff72c6acb4"
E0_MH_P_COMMIT = e0_ml.E0_MH_P_COMMIT
E0_MI_P_COMMIT = e0_ml.E0_MI_P_COMMIT
E0_MJ_P_COMMIT = e0_ml.E0_MJ_P_COMMIT
E0_MK_P_COMMIT = e0_ml.E0_MK_P_COMMIT
P1_1729_CONSUMER_COMMIT = e0_ml.P1_1729_CONSUMER_COMMIT
P1_1729_SEQUENCE_COMMIT = e0_ml.P1_1729_SEQUENCE_COMMIT
...
P1_20260614_SEQUENCE_COMMIT = "9b40b2bea49084aab1ba37a1a5e4b87261a83fae"
P1_20260614_CONSUMER_COMMIT = "46daf1e2dd97a3d7e36ad187d4ae1510dfc14fc2"
PATCH_BASE_COMMIT = P1_20260614_CONSUMER_COMMIT
ANFIS_314159_COMMIT = "45705d620ad529b702624706b07e8a39fc138f72"
ANFIS_314159_PARENT_COMMIT = "929e7da1a8f9afeedde588685ec0adb311345bc2"
...
DEFAULT_PATCH_LOCK_SCHEMA = Path(
    "configs/closure_v1/p1_sequence_seed_314159_patch_lock.schema.json"
)

PATCH_COMPONENT_ROLES = {
    DEFAULT_PATCH_LOCK_SCHEMA.as_posix(): "p1_sequence_seed_314159_patch_lock_schema",
    "docs/closure_v1/E0_M_P1_SEQUENCE_SEED_314159_PATCH_1.md": (
        "p1_sequence_seed_314159_patch_protocol"
    ),
    "src/experiments/build_closure_pipe_sequences.py": (
        "p1_sequence_seed_314159_gate_routing"
    ),
    "src/experiments/closure_p1_sequence_seed_314159_patch.py": (
        "p1_sequence_seed_314159_patch_validator"
    ),
    "src/experiments/lock_closure_p1_sequence_seed_314159_patch.py": (
        "p1_sequence_seed_314159_patch_locker"
    ),
    "tests/test_build_closure_pipe_sequences.py": (
        "p1_sequence_seed_314159_builder_gate_tests"
    ),
    "tests/test_closure_p1_sequence_seed_314159_patch.py": (
        "p1_sequence_seed_314159_patch_tests"
    ),
}
...
E0_ML_SUPERSEDED_PATHS = PATCH_MODIFIED_PATHS
E0_ML_PRESERVED_PATHS = tuple(
    path for path in e0_ml.PATCH_PATHS if path not in E0_ML_SUPERSEDED_PATHS
)
...
# Exact closed collection for the H-E0-MN authority and builder files above.
# Earlier one-shot suites pin consumed prelock namespaces and/or intentionally
# superseded runtime bytes, so they remain historical evidence after the four
# completed P1 slots.
...
P1_20260614_SEQUENCE_PATH = Path(
    "data/closure_v1/development/sequences/P1/seed_20260614.parquet"
)
P1_20260614_POINTER_PATH = Path(f"{P1_20260614_SEQUENCE_PATH.as_posix()}.dvc")
P1_20260614_SUMMARY_PATH = Path(
    "reports/closure_v1/01_surface/sequences/P1/seed_20260614_summary.csv"
)
P1_20260614_SEQUENCE_MANIFEST_PATH = Path(
    "reports/closure_v1/01_surface/sequences/P1/seed_20260614_manifest.json"
)
P1_20260614_REPORT_PATH = Path(
    "reports/closure_v1/02_models/P1/seed_20260614_report.md"
)
P1_20260614_MODEL_MANIFEST_PATH = Path(
    "reports/closure_v1/02_models/P1/seed_20260614_manifest.json"
)
P1_20260614_PRESENT_PATHS = (
    P1_20260614_SEQUENCE_PATH,
    P1_20260614_POINTER_PATH,
    P1_20260614_SUMMARY_PATH,
    P1_20260614_SEQUENCE_MANIFEST_PATH,
    P1_20260614_REPORT_PATH,
    P1_20260614_MODEL_MANIFEST_PATH,
)
P1_20260614_SEQUENCE_COMMIT_PATHS = (
    P1_20260614_POINTER_PATH.as_posix(),
    P1_20260614_SEQUENCE_MANIFEST_PATH.as_posix(),
    P1_20260614_SUMMARY_PATH.as_posix(),
    "src/experiments/audit_closure_p1_seed_20260614_sequence_bundle.py",
    "tests/test_audit_closure_p1_seed_20260614_sequence_bundle.py",
)

ANFIS_314159_STATE_PATH = Path(
    "data/closure_v1/development/anfis/seed_314159/"
    "adaptive_no_current_state.parquet"
)
ANFIS_314159_POINTER_PATH = Path(
    f"{ANFIS_314159_STATE_PATH.as_posix()}.dvc"
)
ANFIS_314159_MANIFEST_PATH = Path(
...
EXPECTED_ARTIFACTS = {
    ...
    P1_20260614_SEQUENCE_PATH.as_posix(): (1_380_317, "4227d4e956303d16873401b1b52ab2a480dc6c1276eaff883d15d10b2a9d81cb"),
    P1_20260614_POINTER_PATH.as_posix(): (104, "29c8bdc33a97e399c84986c6b00a2d957ede94957f3d1a619529cf1f54db8ec2"),
    P1_20260614_SUMMARY_PATH.as_posix(): (356, "a6c6c837a82c13a9321233de03b588c60b7a4198b77dcf31b3c7a62027752c3e"),
    P1_20260614_SEQUENCE_MANIFEST_PATH.as_posix(): (6_541, "e297f0d97b81c7d02bcee39dcb15f760620d3e62990313aba9c7589234ab277a"),
    P1_20260614_REPORT_PATH.as_posix(): (178, "1faf20e1263de7ad346430f75bffd4f6e501af9f7b714cfa6a66c73924450229"),
    P1_20260614_MODEL_MANIFEST_PATH.as_posix(): (17_029, "6276de2f4560cdb6650600afc3a4557aacf588c80739d6b7d416219bf1fec659"),
    ANFIS_314159_STATE_PATH.as_posix(): (1_214_293, "53e71211cf0f58f78bb473869dcac7e15b578c39d6722eba02954c13a86101f0"),
    ANFIS_314159_POINTER_PATH.as_posix(): (116, "1c91d9c32feb0fbafe427e1d1f8c9e6252cb37570e0ae819ba54f587a6d4c181"),
    ANFIS_314159_MANIFEST_PATH.as_posix(): (20_821, "dedcc82dd998499fa5f3f8049554431b1e97dcf6dff32645e7e6bf4e5240f2f4"),
}

PATCH_CORRECTION = {
    "issue_id": "p1_sequence_next_seed_authority_1",
    "classification": "ordered_seed_progression_authority_only",
    "historical_e0_ml_effective_loader_called": False,
    "historical_e0_mm_effective_loader_called": False,
    "p1_1729_consumer_preserved": True,
    "p1_20260612_consumer_preserved": True,
    "p1_20260613_consumer_preserved": True,
    "p1_20260614_consumer_preserved": True,
...
class P1SequenceSeed314159PatchError(RuntimeError):
    """Raised when E0-MN cannot prove its closed next-seed authority."""


def _translate(error: BaseException) -> P1SequenceSeed314159PatchError:
    return P1SequenceSeed314159PatchError(str(error))
...
def _git(*args: str) -> str:
    try:
        return e0_ml._git(*args)
    except e0_ml.P1SequenceSeed20260614PatchError as exc:
        raise _translate(exc) from exc


def _require_commit(value: str, *, context: str) -> str:
    try:
        return e0_ml._require_commit(value, context=context)
    except e0_ml.P1SequenceSeed20260614PatchError as exc:
        raise _translate(exc) from exc
...
def _require_ancestor(ancestor: str, descendant: str) -> None:
    try:
        e0_ml._require_ancestor(ancestor, descendant)
    except e0_ml.P1SequenceSeed20260614PatchError as exc:
        raise _translate(exc) from exc
...
def _git_blob(commit: str, path: str) -> bytes:
    try:
        return e0_ml._git_blob(commit, path)
    except e0_ml.P1SequenceSeed20260614PatchError as exc:
        raise _translate(exc) from exc
...
def _file_record(path: Path, *, role: str) -> dict[str, Any]:
    try:
        return e0_ml._file_record(path, role=role)
    except e0_ml.P1SequenceSeed20260614PatchError as exc:
        raise _translate(exc) from exc
...
def _load_regular_json(path: Path, *, context: str) -> dict[str, Any]:
    try:
        return e0_ml._load_regular_json(path, context=context)
    except e0_ml.P1SequenceSeed20260614PatchError as exc:
        raise _translate(exc) from exc
...
def preflight_p1_sequence_seed_314159_patch_schema(
    schema_path: Path = DEFAULT_PATCH_LOCK_SCHEMA,
) -> dict[str, Any]:
    """Prove the physical E0-MN schema is supported before heavy checks."""
    if schema_path != DEFAULT_PATCH_LOCK_SCHEMA:
        raise P1SequenceSeed314159PatchError(
            "E0-MN schema preflight requires the closed default path"
        )
    schema = _load_regular_json(schema_path, context="E0-MN schema preflight")
    ...
    if type(record["bytes"]) is not int or record["bytes"] <= 0:
        raise P1SequenceSeed314159PatchError(
            "E0-MN schema must be a non-empty regular JSON file"
        )
    return {
        "gate": PATCH_GATE,
...
def _canonical_json_record(
    ...
    *,
    ...
    try:
        return e0_ml._canonical_json_record(
            payload,
            path,
            role=role,
            context=context,
...
def _introduced_commit(path: str) -> str:
    try:
        return e0_ml._introduced_commit(path)
    except e0_ml.P1SequenceSeed20260614PatchError as exc:
        raise _translate(exc) from exc
...
def _observed_diff_entries(base: str, head: str) -> list[dict[str, str]]:
    try:
        return e0_ml._observed_diff_entries(base, head)
    except e0_ml.P1SequenceSeed20260614PatchError as exc:
        raise _translate(exc) from exc
...
def _assert_paths_untouched(
    ...
    *,
    ...
    try:
        e0_ml._assert_paths_untouched(base, descendant, paths, context=context)
    except e0_ml.P1SequenceSeed20260614PatchError as exc:
        raise _translate(exc) from exc
...
def patch_git_diff_payload(patch_head: str) -> dict[str, Any]:
    patch_head = _require_commit(patch_head, context="H-E0-MN")
    ancestry = _git("rev-list", "--parents", "-n", "1", patch_head).split()
    if ancestry != [patch_head, PATCH_BASE_COMMIT]:
        raise P1SequenceSeed314159PatchError(
            "H-E0-MN must be the direct non-merge child of P1/20260614"
        )
    expected = [
    ...
    if observed != expected:
        raise P1SequenceSeed314159PatchError(
            f"H-E0-MN diff differs from its closed 2M+5A allowlist: {observed}"
        )
    return {
...
def _historical_e0_ml_authority(*, execution_head: str) -> dict[str, Any]:
    payload = _load_regular_json(
        e0_ml.DEFAULT_PATCH_LOCK_PATH,
        context="P-E0-ML lock",
    )
    schema = _load_regular_json(
        e0_ml.DEFAULT_PATCH_LOCK_SCHEMA,
        context="H-E0-ML schema",
    )
    try:
        ...
        raise _translate(exc) from exc
    fixed = {
        "lock_version": e0_ml.LOCK_VERSION,
        "status": e0_ml.PATCH_STATUS,
        "experiment_id": e0_ml.EXPERIMENT_ID,
        "surface_id": e0_ml.SURFACE_ID,
        "gate": e0_ml.PATCH_GATE,
        "patch_id": e0_ml.PATCH_ID,
        "authorizations": e0_ml.PATCH_AUTHORIZATIONS,
        "seals": e0_ml.PATCH_SEALS,
    }
    if any(payload.get(field) != expected for field, expected in fixed.items()):
        raise P1SequenceSeed314159PatchError(
            "Historical E0-ML fixed contract drifted"
        )
    repository = cast(Mapping[str, Any], payload["patch_repository"])
    if repository.get("head") != E0_ML_H_COMMIT:
        raise P1SequenceSeed314159PatchError("Historical E0-ML H commit drifted")
    if payload.get("git_diff") != e0_ml.patch_git_diff_payload(E0_ML_H_COMMIT):
        raise P1SequenceSeed314159PatchError("Historical E0-ML diff drifted")
    expected_components = e0_ml.patch_component_bundle(E0_ML_H_COMMIT)
    if payload.get("patch_components") != expected_components:
        raise P1SequenceSeed314159PatchError(
            "Historical E0-ML component bundle drifted"
        )
    ancestry = _git("rev-list", "--parents", "-n", "1", E0_ML_P_COMMIT).split()
    if ancestry != [E0_ML_P_COMMIT, E0_ML_H_COMMIT]:
        raise P1SequenceSeed314159PatchError("P-E0-ML topology drifted")
    expected_publication = [
        {"status": "A", "path": e0_ml.DEFAULT_PATCH_LOCK_PATH.as_posix()},
        {"status": "A", "path": e0_ml.DEFAULT_PATCH_MANIFEST_PATH.as_posix()},
    ]
    if _observed_diff_entries(E0_ML_H_COMMIT, E0_ML_P_COMMIT) != expected_publication:
        raise P1SequenceSeed314159PatchError("P-E0-ML scope drifted")
    _require_ancestor(E0_ML_P_COMMIT, execution_head)
    _assert_paths_untouched(
        E0_ML_P_COMMIT,
        execution_head,
        (
            e0_ml.DEFAULT_PATCH_LOCK_PATH.as_posix(),
            e0_ml.DEFAULT_PATCH_MANIFEST_PATH.as_posix(),
        ),
    ...
    if set(by_path) != set(e0_ml.PATCH_PATHS) or len(by_path) != len(records):
        raise P1SequenceSeed314159PatchError(
            "Historical E0-ML component paths drifted"
        )
    superseded = [by_path[path] for path in E0_ML_SUPERSEDED_PATHS]
    preserved = [by_path[path] for path in E0_ML_PRESERVED_PATHS]
    for record in records:
        if record != _git_record(
            ...
            raise P1SequenceSeed314159PatchError(
                f"Historical E0-ML Git record drifted: {record['path']}"
            )
    for record in preserved:
        if _file_record(
            ...
            raise P1SequenceSeed314159PatchError(
                f"Preserved E0-ML component drifted: {record['path']}"
            )
    _assert_paths_untouched(
        E0_ML_H_COMMIT,
        execution_head,
        E0_ML_PRESERVED_PATHS,
        context="preserved H-E0-ML components",
    )
    ...
    companion_record = _file_record(
        e0_ml.DEFAULT_PATCH_MANIFEST_PATH,
    ...
    if lock_record != _git_record(
        ...
        raise P1SequenceSeed314159PatchError(
            "Published E0-ML lock bundle drifted"
        )
    companion = _load_regular_json(
        e0_ml.DEFAULT_PATCH_MANIFEST_PATH,
        context="P-E0-ML companion",
    )
    try:
        expected_companion = e0_ml._expected_companion(
            payload,
    ...
    if companion != expected_companion:
        raise P1SequenceSeed314159PatchError(
            "Published E0-ML companion drifted"
        )
    return {
        "gate": "E0-ML",
        "patch_head": E0_ML_H_COMMIT,
        "lock_commit": E0_ML_P_COMMIT,
        "lock": lock_record,
...
def _historical_e0_mm_authority(*, execution_head: str) -> dict[str, Any]:
    payload = _load_regular_json(e0_mm.DEFAULT_PATCH_LOCK_PATH, context="P-E0-MM lock")
    schema = _load_regular_json(e0_mm.DEFAULT_PATCH_LOCK_SCHEMA, context="H-E0-MM schema")
    try:
        validate_json_schema(
            payload,
            schema,
        ...
        raise _translate(exc) from exc
    fixed = {
        "lock_version": e0_mm.LOCK_VERSION,
        "status": e0_mm.PATCH_STATUS,
        "experiment_id": e0_mm.EXPERIMENT_ID,
        "surface_id": e0_mm.SURFACE_ID,
        "gate": e0_mm.PATCH_GATE,
        "patch_id": e0_mm.PATCH_ID,
        "authorizations": e0_mm.PATCH_AUTHORIZATIONS,
        "seals": e0_mm.PATCH_SEALS,
    }
    if any(payload.get(field) != expected for field, expected in fixed.items()):
        raise P1SequenceSeed314159PatchError(
            "Historical E0-MM fixed contract drifted"
        )
    if cast(Mapping[str, Any], payload["patch_repository"]).get("head") != E0_MM_H_COMMIT:
        raise P1SequenceSeed314159PatchError("Historical E0-MM H commit drifted")
    if payload.get("git_diff") != e0_mm.patch_git_diff_payload(E0_MM_H_COMMIT):
        raise P1SequenceSeed314159PatchError("Historical E0-MM diff drifted")
    components = e0_mm.patch_component_bundle(E0_MM_H_COMMIT)
    if payload.get("patch_components") != components:
        raise P1SequenceSeed314159PatchError(
            "Historical E0-MM component bundle drifted"
        )
    ancestry = _git("rev-list", "--parents", "-n", "1", E0_MM_P_COMMIT).split()
    if ancestry != [E0_MM_P_COMMIT, E0_MM_H_COMMIT]:
        raise P1SequenceSeed314159PatchError("P-E0-MM topology drifted")
    expected_publication = [
        {"status": "A", "path": e0_mm.DEFAULT_PATCH_LOCK_PATH.as_posix()},
        {"status": "A", "path": e0_mm.DEFAULT_PATCH_MANIFEST_PATH.as_posix()},
    ]
    if _observed_diff_entries(E0_MM_H_COMMIT, E0_MM_P_COMMIT) != expected_publication:
        raise P1SequenceSeed314159PatchError("P-E0-MM scope drifted")
    _require_ancestor(E0_MM_P_COMMIT, execution_head)
    _assert_paths_untouched(
        E0_MM_P_COMMIT,
        execution_head,
        (
            e0_mm.DEFAULT_PATCH_LOCK_PATH.as_posix(),
            e0_mm.DEFAULT_PATCH_MANIFEST_PATH.as_posix(),
        ),
        context="P-E0-MM publication",
    )
    lock_record = _file_record(
        e0_mm.DEFAULT_PATCH_LOCK_PATH,
        role="external_p1_temporal_consumer_seed_20260614_patch_lock",
    )
    companion_record = _file_record(
        e0_mm.DEFAULT_PATCH_MANIFEST_PATH,
    ...
    if lock_record != _git_record(
        ...
        raise P1SequenceSeed314159PatchError(
            "Published E0-MM lock bundle drifted"
        )
    companion = _load_regular_json(
        e0_mm.DEFAULT_PATCH_MANIFEST_PATH,
        context="P-E0-MM companion",
    )
    try:
        expected_companion = e0_mm._expected_companion(
            payload,
            lock_record=lock_record,
        )
    except e0_mm.P1TemporalConsumerSeed20260614PatchError as exc:
        raise _translate(exc) from exc
    if companion != expected_companion:
        raise P1SequenceSeed314159PatchError("Historical E0-MM companion drifted")
    records = [
        dict(record)
        for record in cast(Sequence[Mapping[str, Any]], components["records"])
    ]
    for record in records:
        if _file_record(Path(str(record["path"])), role=str(record["role"])) != record:
            raise P1SequenceSeed314159PatchError(
                f"Preserved E0-MM component drifted: {record['path']}"
            )
    _assert_paths_untouched(
        E0_MM_H_COMMIT,
        execution_head,
        e0_mm.PATCH_PATHS,
        context="preserved H-E0-MM components",
    )
    return {
        "gate": "E0-MM",
        "patch_head": E0_MM_H_COMMIT,
        "lock_commit": E0_MM_P_COMMIT,
        "lock": lock_record,
        "companion_manifest": companion_record,
        "preserved_components": _component_set(
            records,
...
def _published_p1_1729_bundle(*, execution_head: str) -> dict[str, Any]:
    ...
    if sequence_ancestry != [
        P1_1729_SEQUENCE_COMMIT,
        e0_ml.e0_mj.e0_mh.E0_MC_P_COMMIT,
    ]:
        raise P1SequenceSeed314159PatchError(
    ...
    if ancestry != [
        ...
        e0_ml.e0_mj.e0_mh.E0_MG_P_COMMIT,
    ]:
        raise P1SequenceSeed314159PatchError(
...
def _published_p1_20260614_bundle(*, execution_head: str) -> dict[str, Any]:
    sequence_ancestry = _git(
        "rev-list", "--parents", "-n", "1", P1_20260614_SEQUENCE_COMMIT
    ).split()
    if sequence_ancestry != [P1_20260614_SEQUENCE_COMMIT, E0_ML_P_COMMIT]:
        raise P1SequenceSeed314159PatchError(
            "P1/20260614 sequence publication topology drifted"
        )
    expected_sequence_diff = [
        {"status": "A", "path": path}
        for path in P1_20260614_SEQUENCE_COMMIT_PATHS
    ]
    if _observed_diff_entries(E0_ML_P_COMMIT, P1_20260614_SEQUENCE_COMMIT) != (
        expected_sequence_diff
    ):
        raise P1SequenceSeed314159PatchError(
            "P1/20260614 sequence publication scope drifted"
        )
    for path in P1_20260614_SEQUENCE_COMMIT_PATHS:
        entry = _git("ls-tree", P1_20260614_SEQUENCE_COMMIT, "--", path).split(
            maxsplit=3
        )
        if (
            len(entry) != 4
            ...
            raise P1SequenceSeed314159PatchError(
                f"P1/20260614 sequence publication mode drifted: {path}"
            )
    _require_ancestor(P1_20260614_SEQUENCE_COMMIT, execution_head)
    _assert_paths_untouched(
        P1_20260614_SEQUENCE_COMMIT,
        execution_head,
        P1_20260614_SEQUENCE_COMMIT_PATHS,
        context="published P1/20260614 sequence bundle",
    )
    ancestry = _git(
        "rev-list", "--parents", "-n", "1", P1_20260614_CONSUMER_COMMIT
    ).split()
    if ancestry != [P1_20260614_CONSUMER_COMMIT, E0_MM_P_COMMIT]:
        raise P1SequenceSeed314159PatchError(
            "P1/20260614 consumer publication topology drifted"
        )
    expected_diff = [
        {"status": "A", "path": P1_20260614_MODEL_MANIFEST_PATH.as_posix()},
        {"status": "A", "path": P1_20260614_REPORT_PATH.as_posix()},
    ]
    if (
        _observed_diff_entries(E0_MM_P_COMMIT, P1_20260614_CONSUMER_COMMIT)
        != expected_diff
    ):
        raise P1SequenceSeed314159PatchError(
            "P1/20260614 consumer publication scope drifted"
        )
    for record in expected_diff:
        path = record["path"]
        entry = _git("ls-tree", P1_20260614_CONSUMER_COMMIT, "--", path).split(
            maxsplit=3
        )
        if (
            len(entry) != 4
            ...
            raise P1SequenceSeed314159PatchError(
                f"P1/20260614 consumer publication mode drifted: {path}"
            )
    _require_ancestor(P1_20260614_CONSUMER_COMMIT, execution_head)
    tracked_paths = tuple(path.as_posix() for path in P1_20260614_PRESENT_PATHS[1:])
    _assert_paths_untouched(
        P1_20260614_CONSUMER_COMMIT,
        execution_head,
        tracked_paths,
        context="published P1/20260614 bundle",
    )
    records = [
        _expected_artifact_record(path, role=f"p1_20260614_{index}")
        for index, path in enumerate(P1_20260614_PRESENT_PATHS, start=1)
    ]
    for record in records[1:4]:
        if _git_record(
            P1_20260614_SEQUENCE_COMMIT,
            ...
            raise P1SequenceSeed314159PatchError(
                f"Published P1/20260614 sequence record drifted: {record['path']}"
            )
    for record in records[4:]:
        if _git_record(
            P1_20260614_CONSUMER_COMMIT,
            ...
            raise P1SequenceSeed314159PatchError(
                f"Published P1/20260614 consumer record drifted: {record['path']}"
            )
    manifest = _load_regular_json(
        P1_20260614_MODEL_MANIFEST_PATH,
        context="P1/20260614 model manifest",
    )
    expected_fields = {
        "status": "completed",
        "slot_status": "model_unavailable",
    ...
    if drifted or next(reversed(manifest)) != "completion_marker_written_last":
        raise P1SequenceSeed314159PatchError(
            f"P1/20260614 model-unavailable manifest drifted: {drifted}"
        )
    report_record = EXPECTED_ARTIFACTS[P1_20260614_REPORT_PATH.as_posix()]
    if manifest.get("outputs") != [
        {
            "path": P1_20260614_REPORT_PATH.as_posix(),
            "bytes": report_record[0],
            "sha256": report_record[1],
            "artifact_role": "report",
        }
        ...
        raise P1SequenceSeed314159PatchError(
            "P1/20260614 manifest does not bind only its report"
        )
    observed = {
        path.as_posix()
        for path in availability._p1_absence_paths(20_260_614)
        if _path_entry_exists(path)
    }
    expected_present = {path.as_posix() for path in P1_20260614_PRESENT_PATHS}
    if observed != expected_present:
        raise P1SequenceSeed314159PatchError(
            "P1/20260614 namespace differs from its closed publication: "
            f"{sorted(observed)}"
        )
    return {
        "sequence_commit": P1_20260614_SEQUENCE_COMMIT,
        "consumer_commit": P1_20260614_CONSUMER_COMMIT,
        "records": records,
        "records_sha256": _record_digest(records),
        "present_paths": sorted(expected_present),
        "model_unavailable_semantics_verified": True,
...
def _anfis_314159_state_bundle(*, execution_head: str) -> dict[str, Any]:
    ancestry = _git("rev-list", "--parents", "-n", "1", ANFIS_314159_COMMIT).split()
    if ancestry != [ANFIS_314159_COMMIT, ANFIS_314159_PARENT_COMMIT]:
        raise P1SequenceSeed314159PatchError(
            "ANFIS 314159 publication topology drifted"
        )
    _require_ancestor(ANFIS_314159_COMMIT, execution_head)
    tracked = (
        ANFIS_314159_POINTER_PATH.as_posix(),
        ANFIS_314159_MANIFEST_PATH.as_posix(),
    )
    _assert_paths_untouched(
        ANFIS_314159_COMMIT,
        execution_head,
        tracked,
        context="ANFIS 314159 publication",
    )
    records = [
        _expected_artifact_record(
            ANFIS_314159_STATE_PATH,
            role="anfis_314159_state_parquet",
        ),
        _expected_artifact_record(
            ANFIS_314159_POINTER_PATH,
            role="anfis_314159_state_pointer",
        ),
        _expected_artifact_record(
            ANFIS_314159_MANIFEST_PATH,
    ...
    for record in records[1:]:
        if _git_record(
            ...
            raise P1SequenceSeed314159PatchError(
                f"ANFIS 314159 Git record drifted: {record['path']}"
            )
    manifest = _load_regular_json(
        ANFIS_314159_MANIFEST_PATH,
        context="ANFIS 314159 manifest",
    )
    expected_fields = {
    ...
    if drifted:
        raise P1SequenceSeed314159PatchError(
            f"ANFIS 314159 manifest drifted: {drifted}"
        )
    state_expected = EXPECTED_ARTIFACTS[ANFIS_314159_STATE_PATH.as_posix()]
    outputs = manifest.get("outputs")
    if not isinstance(outputs, Sequence) or isinstance(outputs, (str, bytes)):
        raise P1SequenceSeed314159PatchError("ANFIS 314159 outputs drifted")
    state_matches = [
        record
        for record in outputs
        if isinstance(record, Mapping)
        and record.get("path") == ANFIS_314159_STATE_PATH.as_posix()
        and record.get("bytes") == state_expected[0]
        and record.get("sha256") == state_expected[1]
    ]
    if len(state_matches) != 1:
        raise P1SequenceSeed314159PatchError(
            "ANFIS 314159 manifest does not bind its state exactly once"
        )
    return {
        "publication_commit": ANFIS_314159_COMMIT,
        "records": records,
        "records_sha256": _record_digest(records),
        "slot_status": "available",
        "fit_status": "passed",
...
def p1_seed_314159_namespace_absence() -> dict[str, Any]:
    contract = _sequence_prelock_contract()
    existing = [
        path.as_posix()
        for path in p1_seed_314159_namespace_paths()
        if _path_entry_exists(path)
    ]
    if existing:
        raise P1SequenceSeed314159PatchError(
            f"P1 seed 314159 namespace is not pristine: {existing}"
        )
    return contract
...
def _progression_prelock_contract() -> dict[str, Any]:
    ...
    later_paths = tuple(
        path
        for seed in expected_seed_order[5:]
        for path in availability._p1_absence_paths(seed)
    )
    if (
        len(all_paths) != 140
        ...
        or len(present) != 24
        or len(absent) != 116
        or len(prior_residuals) != 88
        or len(target_paths) != 28
        or len(later_paths) != 0
    ):
        raise P1SequenceSeed314159PatchError(
    ...
    return {
        ...
        "completed_seeds": [1729, 20_260_612, 20_260_613, 20_260_614],
...
def closure_progression_prelock() -> dict[str, Any]:
    ...
    if observed != expected or existing_e0_m or outcome:
        raise P1SequenceSeed314159PatchError(
            "Closure progression is not pristine before P1 seed 314159: "
...
# preserve the ordered progression (four prior slots closed; 314159 absent).
def p1_sequence_namespace_absence() -> dict[str, Any]:
    return p1_seed_314159_namespace_absence()
...
def collect_p1_sequence_seed_314159_patch_prelock_state(
    *,
    verify_remote: bool,
) -> dict[str, Any]:
    ...
    if status:
        raise P1SequenceSeed314159PatchError(
            f"H-E0-MN lock requires a clean worktree: {status}"
        )
    head = _require_commit(_git("rev-parse", "HEAD"), context="H-E0-MN HEAD")
    if _git("branch", "--show-current") != "main":
        raise P1SequenceSeed314159PatchError("H-E0-MN requires branch main")
    published = _require_commit(_git("rev-parse", PUBLISHED_REF), context=PUBLISHED_REF)
    if published != head:
        raise P1SequenceSeed314159PatchError("H-E0-MN HEAD differs from origin/main")
    remote = _remote_main_oid() if verify_remote else published
    if remote != head:
        raise P1SequenceSeed314159PatchError(
            "H-E0-MN HEAD differs from live origin/main"
        )
    ...
    for record in cast(Sequence[Mapping[str, Any]], components["records"]):
        if _file_record(Path(str(record["path"])), role=str(record["role"])) != record:
            raise P1SequenceSeed314159PatchError(
                f"Physical H-E0-MN component drifted: {record['path']}"
            )
    builder = next(
        dict(record)
        for record in cast(Sequence[Mapping[str, Any]], components["records"])
    ...
    return {
        ...
        "base_authorities": {
            "e0_ml": _historical_e0_ml_authority(execution_head=head),
            "e0_mm": _historical_e0_mm_authority(execution_head=head),
        },
        ...
        "p1_20260614_publication": _published_p1_20260614_bundle(
            execution_head=head
        ),
        "anfis_314159_state_bundle": _anfis_314159_state_bundle(
            execution_head=head
        ),
        "current_runtime_builder_record": builder,
        "sequence_prelock": p1_seed_314159_namespace_absence(),
...
def _validate_command_evidence(
    ...
    *,
    ...
    if not isinstance(value, Mapping):
        raise P1SequenceSeed314159PatchError(
            f"E0-MN {context} evidence must be an object"
        )
    expected_keys = {
        "command",
        "returncode",
    ...
    if set(value) != expected_keys or tuple(value.get("command", ())) != tuple(command):
        raise P1SequenceSeed314159PatchError(
            f"E0-MN {context} command evidence drifted"
        )
    if value.get("returncode") != 0:
        raise P1SequenceSeed314159PatchError(f"E0-MN {context} did not pass")
    for field in ("stdout_sha256", "stderr_sha256"):
        digest = value.get(field)
        if not isinstance(digest, str) or len(digest) != 64:
            raise P1SequenceSeed314159PatchError(
                f"E0-MN {context} {field} drifted"
            )
...
def validate_p1_sequence_seed_314159_patch_verification(
    payload: Mapping[str, Any],
) -> None:
    commands = {
    ...
    if set(payload) != {*commands, "schema_subset_preflight"}:
        raise P1SequenceSeed314159PatchError(
            "E0-MN verification fields drifted"
        )
    schema_preflight = payload.get("schema_subset_preflight")
    if (
        not isinstance(schema_preflight, Mapping)
        or dict(schema_preflight)
        != preflight_p1_sequence_seed_314159_patch_schema()
    ):
        raise P1SequenceSeed314159PatchError(
            "E0-MN schema preflight evidence drifted"
        )
    ...
    if (
        ...
        raise P1SequenceSeed314159PatchError(
            "E0-MN focused-test evidence drifted"
        )


def build_p1_sequence_seed_314159_patch_lock_payload(
    ...
    *,
    ...
    return {
        ...
        "p1_20260614_publication": dict(
            cast(Mapping[str, Any], prelock["p1_20260614_publication"])
        ),
        "anfis_314159_state_bundle": dict(
            cast(Mapping[str, Any], prelock["anfis_314159_state_bundle"])
        ),
...
def validate_p1_sequence_seed_314159_patch_lock_payload(
    payload: Mapping[str, Any],
    ...
    *,
    ...
    try:
        validate_json_schema(
            payload,
            schema,
            instance_path="$.p1_sequence_seed_314159_patch_lock",
        )
    except ClosureContractError as exc:
        raise _translate(exc) from exc
    fixed = {
    ...
    for field, expected in fixed.items():
        if payload.get(field) != expected:
            raise P1SequenceSeed314159PatchError(
                f"E0-MN fixed field drifted: {field}"
            )
    created = payload.get("created_at_utc")
    if not isinstance(created, str):
        raise P1SequenceSeed314159PatchError("E0-MN timestamp is invalid")
    try:
        timestamp = datetime.fromisoformat(created.replace("Z", "+00:00"))
    except ValueError as exc:
        raise P1SequenceSeed314159PatchError("E0-MN timestamp is invalid") from exc
    if timestamp.utcoffset() is None:
        raise P1SequenceSeed314159PatchError(
            "E0-MN timestamp requires a timezone"
        )
    repository = cast(Mapping[str, Any], payload["patch_repository"])
    patch_head = _require_commit(str(repository.get("head", "")), context="H-E0-MN")
    if repository != {
        "head": patch_head,
        "parent": PATCH_BASE_COMMIT,
        "branch": "main",
        ...
        raise P1SequenceSeed314159PatchError(
            "E0-MN patch repository record drifted"
        )
    if payload.get("git_diff") != patch_git_diff_payload(patch_head):
        raise P1SequenceSeed314159PatchError("E0-MN Git diff drifted")
    components = patch_component_bundle(patch_head)
    if payload.get("patch_components") != components:
        raise P1SequenceSeed314159PatchError("E0-MN component bundle drifted")
    ...
    if require_physical_patch_components:
        ...
        _assert_paths_untouched(
            ...
            execution_head,
            PATCH_PATHS,
            context="H-E0-MN components",
        )
    expected_authorities = {
        "e0_ml": _historical_e0_ml_authority(execution_head=execution_head),
        "e0_mm": _historical_e0_mm_authority(execution_head=execution_head),
    }
    if payload.get("base_authorities") != expected_authorities:
        raise P1SequenceSeed314159PatchError(
            "E0-MN historical authorities drifted"
        )
    if payload.get("p1_1729_publication") != _published_p1_1729_bundle(
        execution_head=execution_head
    ):
        raise P1SequenceSeed314159PatchError("P1/1729 publication drifted")
    if payload.get("p1_20260612_publication") != _published_p1_20260612_bundle(
        execution_head=execution_head
    ):
        raise P1SequenceSeed314159PatchError("P1/20260612 publication drifted")
    if payload.get("p1_20260613_publication") != _published_p1_20260613_bundle(
        execution_head=execution_head
    ):
        raise P1SequenceSeed314159PatchError("P1/20260613 publication drifted")
    if payload.get("p1_20260614_publication") != _published_p1_20260614_bundle(
        execution_head=execution_head
    ):
        raise P1SequenceSeed314159PatchError("P1/20260614 publication drifted")
    if payload.get("anfis_314159_state_bundle") != _anfis_314159_state_bundle(
        execution_head=execution_head
    ):
        raise P1SequenceSeed314159PatchError("ANFIS 314159 bundle drifted")
    builder_records = [
        record
        for record in cast(Sequence[Mapping[str, Any]], components["records"])
        if record["path"] == "src/experiments/build_closure_pipe_sequences.py"
    ...
    if len(builder_records) != 1:
        raise P1SequenceSeed314159PatchError("E0-MN builder record is not unique")
    ...
    if payload.get("current_runtime_builder_record") != expected_builder:
        raise P1SequenceSeed314159PatchError("E0-MN current builder drifted")
    if payload.get("sequence_prelock") != _sequence_prelock_contract():
        raise P1SequenceSeed314159PatchError("E0-MN sequence prelock drifted")
    if payload.get("progression_prelock") != _progression_prelock_contract():
        raise P1SequenceSeed314159PatchError("E0-MN progression prelock drifted")
    validate_p1_sequence_seed_314159_patch_verification(
...
def _expected_companion(
    ...
    *,
    ...
    ml = cast(Mapping[str, Any], authorities["e0_ml"])
    mm = cast(Mapping[str, Any], authorities["e0_mm"])
    ...
    publication_20260614 = cast(
        Mapping[str, Any], payload["p1_20260614_publication"]
    )
    state = cast(Mapping[str, Any], payload["anfis_314159_state_bundle"])
    inputs = [
        _generic_record(
        ...
        _generic_record(
            by_path["src/experiments/closure_p1_sequence_seed_314159_patch.py"],
        ...
        dict(cast(Mapping[str, Any], ml["lock"])),
        dict(cast(Mapping[str, Any], ml["companion_manifest"])),
        dict(cast(Mapping[str, Any], mm["lock"])),
        dict(cast(Mapping[str, Any], mm["companion_manifest"])),
        *[
            dict(record)
            for record in cast(
        ...
        *[
            dict(record)
            for record in cast(
                Sequence[Mapping[str, Any]], publication_20260614["records"]
            )
        ],
        *[
            dict(record)
    ...
    historical_inputs = [
        {
            **dict(record),
            "commit": E0_ML_H_COMMIT,
            "hash_source": "git_blob_at_commit",
        }
        for record in cast(
            Sequence[Mapping[str, Any]],
            cast(Mapping[str, Any], ml["superseded_components"])["records"],
        )
    ]
    ...
    return {
        ...
        "script": _generic_record(
            by_path["src/experiments/lock_closure_p1_sequence_seed_314159_patch.py"],
...
def _validate_p_commit_topology(
    ...
    *,
    ...
    if lock_commit != _introduced_commit(companion_path):
        raise P1SequenceSeed314159PatchError("E0-MN lock commits differ")
    ancestry = _git("rev-list", "--parents", "-n", "1", lock_commit).split()
    if ancestry != [lock_commit, patch_head]:
        raise P1SequenceSeed314159PatchError(
            "P-E0-MN must be the direct child of H-E0-MN"
        )
    expected = [
    ...
    if _observed_diff_entries(patch_head, lock_commit) != expected:
        raise P1SequenceSeed314159PatchError(
            "P-E0-MN must add exactly lock plus companion"
        )
    for path in (lock_path, companion_path):
        ...
        if (
            ...
            raise P1SequenceSeed314159PatchError(
                f"P-E0-MN publication mode drifted: {path}"
            )
...
def _load_unpublished_p1_sequence_seed_314159_patch_lock(
) -> tuple[dict[str, Any], dict[str, Any]]:
    payload = _load_regular_json(DEFAULT_PATCH_LOCK_PATH, context="E0-MN lock")
    schema = _load_regular_json(DEFAULT_PATCH_LOCK_SCHEMA, context="E0-MN schema")
    validate_p1_sequence_seed_314159_patch_lock_payload(payload, schema)
    ...
    companion = _load_regular_json(
        DEFAULT_PATCH_MANIFEST_PATH,
        context="E0-MN companion",
    )
    if companion != _expected_companion(payload, lock_record=lock_record):
        raise P1SequenceSeed314159PatchError("E0-MN companion drifted")
    execution_head = _require_commit(_git("rev-parse", "HEAD"), context="execution HEAD")
    patch_head = str(cast(Mapping[str, Any], payload["patch_repository"])["head"])
    if execution_head != patch_head:
        raise P1SequenceSeed314159PatchError(
            "Unpublished E0-MN validation must run at H-E0-MN"
        )
    return payload, {
...
def load_published_p1_sequence_seed_314159_patch_historical_authority(
) -> tuple[dict[str, Any], dict[str, Any]]:
    payload = _load_regular_json(DEFAULT_PATCH_LOCK_PATH, context="E0-MN lock")
    schema = _load_regular_json(DEFAULT_PATCH_LOCK_SCHEMA, context="E0-MN schema")
    validate_p1_sequence_seed_314159_patch_lock_payload(
        payload,
        schema,
    ...
    if lock_record != _canonical_json_record(
        ...
        raise P1SequenceSeed314159PatchError("Published E0-MN lock drifted")
    companion = _load_regular_json(
        DEFAULT_PATCH_MANIFEST_PATH,
        context="E0-MN companion",
    )
    if companion != _expected_companion(payload, lock_record=lock_record):
        raise P1SequenceSeed314159PatchError("Published E0-MN companion drifted")
    if companion_record != _canonical_json_record(
        ...
        raise P1SequenceSeed314159PatchError(
            "Published E0-MN companion record drifted"
        )
    return payload, {
        "status": "published_p1_sequence_seed_314159_historical_authority_valid",
        "gate": PATCH_GATE,
...
def load_and_validate_p1_sequence_seed_314159_patch_lock(
) -> tuple[dict[str, Any], dict[str, Any]]:
    sequence_before = p1_seed_314159_namespace_absence()
    ...
    if status:
        raise P1SequenceSeed314159PatchError(
            f"E0-MN execution requires a clean worktree: {status}"
        )
    lock_commit, lock_record, companion_record = _validate_p_commit_topology(
        payload,
        execution_head=execution_head,
    ...
    if execution_head != lock_commit:
        raise P1SequenceSeed314159PatchError(
            "E0-MN execution requires HEAD at the exact P commit"
        )
    if _git("branch", "--show-current") != "main":
        raise P1SequenceSeed314159PatchError("E0-MN requires branch main")
    refs = {
    ...
    if set(refs.values()) != {lock_commit}:
        raise P1SequenceSeed314159PatchError(
            f"E0-MN publication refs diverged: {refs}"
        )
    if _remote_main_oid() != lock_commit:
        raise P1SequenceSeed314159PatchError(
            "E0-MN differs from live origin/main"
        )
    if lock_record != _canonical_json_record(
        payload,
        DEFAULT_PATCH_LOCK_PATH,
    ...
    if p1_seed_314159_namespace_absence() != sequence_before:
        raise P1SequenceSeed314159PatchError(
            "E0-MN sequence namespace changed during gate"
        )
    if closure_progression_prelock() != progression_before:
        raise P1SequenceSeed314159PatchError(
            "E0-MN progression namespace changed during gate"
        )
    return payload, {
        "status": "published_p1_sequence_seed_314159_patch_valid",
        "gate": PATCH_GATE,
        "patch_head": payload["patch_repository"]["head"],
        "lock_commit": lock_commit,
        "execution_head": execution_head,
        ...
        "p1_20260614_publication_verified": True,
        "anfis_314159_state_verified": True,
...
def require_p1_sequence_seed_314159_authorized(
    ...
    if failed:
        raise P1SequenceSeed314159PatchError(
            f"E0-MN authorization predicates failed: {failed}"
        )
    required_false = (
    ...
    if drifted:
        raise P1SequenceSeed314159PatchError(
            f"E0-MN fail-closed seals drifted: {drifted}"
        )
    p1_seed_314159_namespace_absence()
