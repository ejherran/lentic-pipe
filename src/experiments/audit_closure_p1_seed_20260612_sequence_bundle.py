#!/usr/bin/env python
"""Reopen and audit the immutable Closure V1 P1 seed 20260612 sequence bundle."""
...
EXPECTED_INPUT_RECORDS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "bytes": 20_883,
        "sha256": "e7523963c6f09ea83235d9578d492ec34a654ce8328f79f1b05e49aa84669053",
    },
    {
        "path": E0_MH_LOCK_PATH.as_posix(),
        "bytes": 25_333,
        "sha256": "2d4386300e6c44977ac5a85df0157d217c624c0ec44df0e1f6bf4f67725b4b17",
    },
    {
        "path": E0_MH_COMPANION_PATH.as_posix(),
        "bytes": 6_365,
    ...
    },
    {
        ...
        "bytes": 1_214_885,
        "sha256": "99b4bc37de88d76068c044423071046cb6b0341056024c4de41cd1af51d09d26",
    },
)
...
EXPECTED_E0_MH_INPUT_RECORDS: tuple[dict[str, Any], ...] = (
    {
        "path": "configs/closure_v1/p1_sequence_seed_20260612_patch_lock.schema.json",
        "role": "p1_sequence_seed_20260612_patch_lock_schema",
        "bytes": 18_338,
        "sha256": "e6baa3594cfbcd7fe2d05f068b3ff9c0c2ad45f2233f5fc47a3bdb4b950aa6ce",
    },
    {
        "path": P1_STATE_PATH.as_posix(),
    ...
    },
    {
        ...
        "bytes": 116,
        "sha256": "7c88755a0cb55a6a177bf6f883f1e879221a5e415e3fd243fc27576051cd00e2",
    },
    *EXPECTED_PRIOR_P1_RECORDS[:2],
    {
        "path": "reports/closure_v1/00_protocol/p1_sequence_historical_anfis_patch_lock.json",
    ...
    {
        "path": "reports/closure_v1/00_protocol/p1_sequence_historical_anfis_patch_lock_manifest.json",
        "role": "p1_sequence_historical_anfis_patch_companion",
        "bytes": 4_814,
        "sha256": "9ac3538ed8076117f34fd94112582e1927e68ee8e298fae26b3d0f714d6e7b63",
    },
    {
        "path": "reports/closure_v1/00_protocol/p1_temporal_consumer_schema_subset_patch_lock.json",
        "role": "external_p1_temporal_consumer_schema_subset_patch_lock",
        "bytes": 136_990,
        "sha256": "f47c8c952b85bb80ef12bb22800b29d7305448fac0066157d6780c3e90062c49",
    },
    {
        "path": "reports/closure_v1/00_protocol/p1_temporal_consumer_schema_subset_patch_lock_manifest.json",
        "role": "p1_temporal_consumer_schema_subset_patch_companion",
        "bytes": 4_302,
        "sha256": "0c2369e70c5ebdb619e801e005e558058a40033f5bd67048410ad2d635a1802e",
    },
    {
        "path": P1_STATE_MANIFEST_PATH.as_posix(),
    ...
    *EXPECTED_PRIOR_P1_RECORDS[3:4],
    *EXPECTED_PRIOR_P1_RECORDS[2:3],
    *EXPECTED_PRIOR_P1_RECORDS[5:6],
    *EXPECTED_PRIOR_P1_RECORDS[4:5],
    {
        "path": "src/experiments/build_closure_pipe_sequences.py",
    ...
    {
        "path": "src/experiments/closure_p1_sequence_seed_20260612_patch.py",
        "role": "p1_sequence_seed_20260612_patch_validator",
        "bytes": 67_074,
        "sha256": "7f7f293c583394e70d2267ba9099a2026d5c356e4b345b96983399ca63759513",
    },
)

EXPECTED_E0_MH_PATCH_RECORDS: tuple[dict[str, Any], ...] = (
    EXPECTED_E0_MH_INPUT_RECORDS[0],
    {
        "path": "docs/closure_v1/E0_M_P1_SEQUENCE_SEED_20260612_PATCH_1.md",
        "role": "p1_sequence_seed_20260612_patch_protocol",
        "bytes": 3_558,
        "sha256": "d64f00f01fa6053f7d61d57a510188e6915ff567ab456e497ab2b3aa77ca0608",
    },
    {
        **historical._physical_record(EXPECTED_INPUT_RECORDS[8]),
        "role": "p1_sequence_seed_20260612_gate_routing",
    },
    EXPECTED_E0_MH_INPUT_RECORDS[-1],
    {
        "path": "src/experiments/lock_closure_p1_sequence_seed_20260612_patch.py",
        "role": "p1_sequence_seed_20260612_patch_locker",
        "bytes": 35_608,
        "sha256": "60b0385f56215f120ce972cc633079aeb137101ddf913d98fbd3b84387c5ec6b",
    },
    {
    ...
    {
        "path": "tests/test_closure_p1_sequence_seed_20260612_patch.py",
        "role": "p1_sequence_seed_20260612_patch_tests",
        "bytes": 33_074,
        "sha256": "8ef4dcddfb5c33904c3f31c7a37623ffbf5e05fdba62bf274e4d8f3d882043d2",
    },
)
...
EXPECTED_HISTORICAL_INPUTS: tuple[dict[str, Any], ...] = (
    {
        ...
        "commit": "5bdac0fe8279297dbdb04e38146726431511fe7a",
...
class ClosureP1Seed20260612SequenceAuditError(ValueError):
    """Raised when the physical P1/20260612 bundle differs from closed evidence."""
...
def _decode_strict_json(payload_bytes: bytes, *, path: str) -> dict[str, Any]:
    def reject_constant(value: str) -> None:
        raise ClosureP1Seed20260612SequenceAuditError(
...
def _closed_paths(*, pointer_present: bool) -> tuple[Path, ...]:
    candidates = (
        ...
        *(Path(str(record["path"])) for record in EXPECTED_E0_MH_INPUT_RECORDS),
        *(Path(str(record["path"])) for record in EXPECTED_E0_MH_PATCH_RECORDS),
...
def _validate_closed_namespace(snapshot: Mapping[str, Any]) -> dict[str, Any]:
    if set(snapshot) != set(NAMESPACE_DIRECTORIES):
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 namespace snapshot dialect drifted"
        )
    entries = {
    ...
    if missing_required:
        raise ClosureP1Seed20260612SequenceAuditError(
            f"P1/20260612 sequence bundle is incomplete: {missing_required}"
        )
    ...
    if forbidden_sequence:
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 bundle has temporary or guard state: "
    ...
    if prior_present != set(PRIOR_P1_PATHS):
        ...
        raise ClosureP1Seed20260612SequenceAuditError(
            f"P1/1729 closed predecessor bundle drifted: {missing}"
        )
    prior_registered = set(historical._registered_seed_paths(1729))
    prior_unexpected = sorted(
        path.as_posix() for path in (prior_registered & present) - set(PRIOR_P1_PATHS)
    )
    if prior_unexpected:
        raise ClosureP1Seed20260612SequenceAuditError(
            f"P1/1729 has unexpected residual paths: {prior_unexpected}"
        )
...
def _require_pre_consumer_progression_clear(
    ...
    if not isinstance(progression, Mapping) or (
        ...
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 pre-consumer CLI gate requires its consumer, later P1, "
...
def _validate_dvc_pointer(sequence: Any, pointer: Any | None) -> dict[str, Any]:
    ...
    if match is None:
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 explicit DVC pointer dialect drifted"
        )
    ...
    if observed_md5 != expected_md5 or observed_size != len(sequence.payload):
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 DVC pointer does not bind the physical Parquet"
        )
    return {
        "state": "post_dvc",
...
def _load_assignment(payload: bytes) -> pd.DataFrame:
    try:
        ...
        raise ClosureP1Seed20260612SequenceAuditError(str(exc)) from exc
...
def _validate_physical_schema(schema: pa.Schema) -> None:
    if schema.names != list(SEQUENCE_COLUMNS):
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 Parquet columns/order drifted"
        )
    for column in SEQUENCE_COLUMNS:
        ...
        if not valid:
            raise ClosureP1Seed20260612SequenceAuditError(
                f"P1/20260612 physical schema drifted: {column}"
            )
...
def _validate_physical_payload(table: pa.Table) -> dict[str, int]:
    ...
    if bool((reasons[success] != "").any()) or (
        ...
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 physical failure reasons drifted"
        )
    ...
    if observed_roles != EXPECTED_ROLE_COUNTS:
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 physical role counts drifted"
        )
    ...
    for column in INPUT_COLUMNS:
        ...
        if values.null_count:
            raise ClosureP1Seed20260612SequenceAuditError(
                f"P1/20260612 input list parents must remain valid: {column}"
            )
        ...
        if bool(child_null[success].any()) or (
            ...
            raise ClosureP1Seed20260612SequenceAuditError(
                f"P1/20260612 input null policy drifted: {column}"
            )
        ...
        if not bool(np.isfinite(child_values[success]).all()):
            raise ClosureP1Seed20260612SequenceAuditError(
                f"P1/20260612 successful input is non-finite: {column}"
            )
    ...
    for column in TARGET_COLUMNS:
        ...
        if bool(nulls[success].any()) or (
            ...
            raise ClosureP1Seed20260612SequenceAuditError(
                f"P1/20260612 target null policy drifted: {column}"
            )
        successful = [
            value
        ...
        if not bool(np.isfinite(np.asarray(successful, dtype=np.float64)).all()):
            raise ClosureP1Seed20260612SequenceAuditError(
                f"P1/20260612 successful target is non-finite: {column}"
            )
    ...
    *,
    ...
    for field, value in expected.items():
        if not _typed_equal(payload.get(field), value):
            raise ClosureP1Seed20260612SequenceAuditError(
                f"P1/20260612 state manifest field drifted: {field}"
            )
    ...
    if matches != [{**dict(state_record), "role": "adaptive_no_current_state"}]:
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 state manifest does not bind its adaptive state"
        )


def _validate_e0_mh_reference(
    ...
    *,
    ...
    for field, value in expected_lock_identity.items():
        if not _typed_equal(lock.get(field), value):
            raise ClosureP1Seed20260612SequenceAuditError(
                f"E0-MH lock identity drifted: {field}"
            )
    ...
    if not _typed_equal(lock.get("authorizations"), expected_authorizations):
        raise ClosureP1Seed20260612SequenceAuditError(
            "E0-MH authorization seals drifted"
        )

    expected_repository = {
        "branch": "main",
        "exact_diff_verified": True,
        "head": "16662cdd5f258a1aa035c0f192145b3bd4d30fab",
        "parent": "5d8bbef0fe58e57cd2180570bd6aef5f07923781",
        "published_head": "16662cdd5f258a1aa035c0f192145b3bd4d30fab",
        "published_ref": "origin/main",
        "remote_main_oid": "16662cdd5f258a1aa035c0f192145b3bd4d30fab",
        "worktree_status": "clean",
    }
    if not _typed_equal(lock.get("patch_repository"), expected_repository):
        raise ClosureP1Seed20260612SequenceAuditError(
            "E0-MH publication topology seal drifted"
        )

    for expected in (*EXPECTED_E0_MH_INPUT_RECORDS, *EXPECTED_E0_MH_PATCH_RECORDS):
        path = str(expected["path"])
        observed = physical_records.get(path)
        if observed is None or not _typed_equal(dict(observed), _physical_record(expected)):
            raise ClosureP1Seed20260612SequenceAuditError(
                f"E0-MH physical record drifted: {path}"
            )
    expected_builder = {
    ...
    if not _typed_equal(lock.get("current_runtime_builder_record"), expected_builder):
        raise ClosureP1Seed20260612SequenceAuditError(
            "E0-MH current builder binding drifted"
        )

    expected_anfis = {
        "fit_status": "passed",
        "future_outcomes_accessed": False,
        "publication_commit": "b16b27d5e38afae493202bba7576bb0c4f52283e",
        "records": [
            dict(EXPECTED_E0_MH_INPUT_RECORDS[index]) for index in (1, 2, 9)
        ],
        "records_sha256": "83292814d5e417d6625acae768b985054b8810f47f033db532793618d24ed83a",
        "slot_status": "available",
        "state_manifest_verified": True,
    }
    if not _typed_equal(lock.get("anfis_20260612_state_bundle"), expected_anfis):
        raise ClosureP1Seed20260612SequenceAuditError(
            "E0-MH ANFIS 20260612 binding drifted"
        )

    prior = lock.get("p1_1729_publication")
    if not isinstance(prior, Mapping) or not _typed_equal(
        prior.get("records"), [dict(record) for record in EXPECTED_PRIOR_P1_RECORDS]
    ):
        raise ClosureP1Seed20260612SequenceAuditError(
            "E0-MH predecessor P1/1729 records drifted"
        )
    ...
    if any(not _typed_equal(prior.get(key), value) for key, value in expected_prior_fields.items()):
        raise ClosureP1Seed20260612SequenceAuditError(
            "E0-MH predecessor P1/1729 semantic seals drifted"
        )

    components = lock.get("patch_components")
    if not isinstance(components, Mapping) or not _typed_equal(
        components.get("records"), [dict(record) for record in EXPECTED_E0_MH_PATCH_RECORDS]
    ):
        raise ClosureP1Seed20260612SequenceAuditError(
            "E0-MH patch component bindings drifted"
        )
    if components.get("count") != len(EXPECTED_E0_MH_PATCH_RECORDS):
        raise ClosureP1Seed20260612SequenceAuditError(
            "E0-MH patch component count drifted"
        )
    ...
    if not isinstance(sequence_prelock, Mapping) or any(
        ...
        raise ClosureP1Seed20260612SequenceAuditError(
            "E0-MH target namespace prelock seal drifted"
        )
    expected_seals = {
    ...
    if not _typed_equal(lock.get("seals"), expected_seals):
        raise ClosureP1Seed20260612SequenceAuditError("E0-MH scientific seals drifted")
    expected_atomicity = {
    ...
    if not _typed_equal(lock.get("sequence_atomicity"), expected_atomicity):
        raise ClosureP1Seed20260612SequenceAuditError(
            "E0-MH sequence atomicity contract drifted"
        )
    ...
    expected_companion_identity = {
        ...
        "authoritative_lock_path": E0_MH_LOCK_PATH.as_posix(),
        "authorized_model_id": MODEL_ID,
        "authorized_base_seed": BASE_SEED,
        "batch_seed_execution_authorized": False,
        "dvc_commands_authorized": False,
    ...
    for field, value in expected_companion_identity.items():
        if not _typed_equal(companion.get(field), value):
            raise ClosureP1Seed20260612SequenceAuditError(
                f"E0-MH companion identity drifted: {field}"
            )
    if not _typed_equal(
        companion.get("inputs"), [dict(record) for record in EXPECTED_E0_MH_INPUT_RECORDS]
    ):
        raise ClosureP1Seed20260612SequenceAuditError(
            "E0-MH companion physical inputs drifted"
        )
    if not _typed_equal(
        ...
        raise ClosureP1Seed20260612SequenceAuditError(
            "E0-MH companion historical inputs drifted"
        )
    expected_script = {
        **_physical_record(EXPECTED_E0_MH_PATCH_RECORDS[4]),
        "role": "generating_script",
    }
    if not _typed_equal(companion.get("script"), expected_script):
        raise ClosureP1Seed20260612SequenceAuditError(
            "E0-MH companion script binding drifted"
        )
    expected_output = {
        **dict(lock_record),
    ...
    if not _typed_equal(companion.get("outputs"), [expected_output]):
        raise ClosureP1Seed20260612SequenceAuditError(
            "E0-MH companion lock binding drifted"
        )
    return {
        "validation_scope": "exact_physical_records_and_locked_semantic_seals",
        "lock_record": dict(lock_record),
        "physical_input_count": len(EXPECTED_E0_MH_INPUT_RECORDS),
        "physical_patch_component_count": len(EXPECTED_E0_MH_PATCH_RECORDS),
        "historical_inputs_compared_to_current_paths": False,
...
def _validate_manifest(
    ...
    *,
    ...
    if set(payload) != MANIFEST_KEYS:
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 manifest top-level dialect drifted"
        )
    expected_identity = {
    ...
    for field, value in expected_identity.items():
        if not _typed_equal(payload.get(field), value):
            raise ClosureP1Seed20260612SequenceAuditError(
                f"P1/20260612 manifest field drifted: {field}"
            )
    generated_at = payload.get("generated_at_utc")
    if not isinstance(generated_at, str):
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 manifest timestamp is absent"
        )
    try:
        parsed = datetime.fromisoformat(generated_at)
    except ValueError as exc:
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 manifest timestamp is invalid"
        ) from exc
    if parsed.tzinfo is None:
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 manifest timestamp must be timezone-aware"
        )
    ...
    for field, expected in exact_sections.items():
        if not _typed_equal(payload.get(field), expected):
            raise ClosureP1Seed20260612SequenceAuditError(
                f"P1/20260612 manifest section drifted: {field}"
            )
    counts = payload.get("counts")
    if not isinstance(counts, Mapping) or set(counts) != MANIFEST_COUNT_KEYS:
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 manifest count dialect drifted"
        )
    if not _typed_equal(dict(counts), _manifest_counts(audit, boundary)):
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 manifest counts differ from reconstruction"
        )
...
def _manifest_last_evidence(manifest: Mapping[str, Any]) -> dict[str, Any]:
    if manifest.get("completion_marker_written_last") is not True:
        raise ClosureP1Seed20260612SequenceAuditError(
            "P1/20260612 completion marker seal drifted"
        )
    return {
        "publication_order": [
            P1_SEQUENCE_PATH.as_posix(),
        ...
        "e0_mh_atomicity_contract_reconciled": True,
...
def _audit_p1_seed_20260612_sequence_bundle() -> dict[str, Any]:
    result: dict[str, Any]
    with historical.secure_reads._RepoReadSession(PROJECT_ROOT) as session:
        ...
        mh_lock_file = file_for(E0_MH_LOCK_PATH)
        mh_companion_file = file_for(E0_MH_COMPANION_PATH)
        mh_lock = _decode_strict_json(
            mh_lock_file.payload,
            path=E0_MH_LOCK_PATH.as_posix(),
        )
        mh_companion = _decode_strict_json(
            mh_companion_file.payload,
            path=E0_MH_COMPANION_PATH.as_posix(),
        )
        _assert_canonical_json(
            mh_lock_file.payload,
        ...
        e0_mh = _validate_e0_mh_reference(
            mh_lock,
            mh_companion,
            lock_record=mh_lock_file.record,
            physical_records=e0_mh_physical_records,
        )
        ...
        if build_audit.role_counts != EXPECTED_ROLE_COUNTS:
            raise ClosureP1Seed20260612SequenceAuditError(
                "P1/20260612 reconstructed role counts drifted"
            )
        if build_audit.status_counts != EXPECTED_STATUS_COUNTS:
            raise ClosureP1Seed20260612SequenceAuditError(
                "P1/20260612 reconstructed status counts drifted"
            )
        if build_audit.failure_reason_counts != EXPECTED_FAILURE_REASON_COUNTS:
            raise ClosureP1Seed20260612SequenceAuditError(
                "P1/20260612 reconstructed failure reasons drifted"
            )
        if (
            ...
            raise ClosureP1Seed20260612SequenceAuditError(
                "P1/20260612 reconstructed delta audit drifted"
            )
        ...
        if physical_schema.names != list(SEQUENCE_COLUMNS):
            raise ClosureP1Seed20260612SequenceAuditError(
                "P1/20260612 Parquet schema has extra or reordered columns"
            )
        ...
        if differing_columns or actual_table.num_rows != expected_table.num_rows:
            raise ClosureP1Seed20260612SequenceAuditError(
                "P1/20260612 rows differ from sealed reconstruction: "
        ...
        if physical != expected_physical:
            raise ClosureP1Seed20260612SequenceAuditError(
                "P1/20260612 physical null evidence drifted"
            )
        ...
        if summary_file.payload != _summary_bytes(expected_frame):
            raise ClosureP1Seed20260612SequenceAuditError(
                "P1/20260612 summary bytes differ from reconstruction"
            )
        ...
        if namespace_before != namespace_after:
            raise ClosureP1Seed20260612SequenceAuditError(
                "P1/20260612 audit namespace changed during readback"
            )
...
def audit_p1_seed_20260612_sequence_bundle() -> dict[str, Any]:
    """Audit the closed P1/20260612 bundle without mutating repository state."""
    try:
        return _audit_p1_seed_20260612_sequence_bundle()
    except ClosureP1Seed20260612SequenceAuditError:
        raise
    except historical.ClosureP1SequenceAuditError as exc:
        raise ClosureP1Seed20260612SequenceAuditError(str(exc)) from exc
    except historical.secure_reads.ClosureP0SequenceAuditError as exc:
        raise ClosureP1Seed20260612SequenceAuditError(
            str(exc).replace("P0", "P1/20260612")
        ) from exc
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Read-only audit of the closed Closure V1 P1/20260612 sequence bundle."
        )
    )
    parser.add_argument(
        CHECK_ONLY_FLAG,
        action="store_true",
        required=True,
        help="Reopen and validate the fixed P1/20260612 bundle without writing outputs.",
    )
...
def main(argv: Sequence[str] | None = None) -> None:
    parse_args(argv)
    try:
        result = audit_p1_seed_20260612_sequence_bundle()
