#!/usr/bin/env python
"""Check and publish the outcome-closed E0-MV model-manifest authority."""
...
from src.experiments import (  # noqa: E402
    closure_anfis_ablation_model_manifest_patch as patch,
)
...
def check_only() -> dict[str, Any]:
    """Run the schema-first, non-writing H-E0-MV preflight."""

    schema = patch.preflight_anfis_ablation_model_manifest_patch_schema()
    prelock = patch.collect_anfis_ablation_model_manifest_patch_prelock_state(
        verify_remote=True
    )
...
def check_effective(
    *, model_id: str, base_seed: int, audit_current_unpublished: bool
    ...
    return patch.load_effective_anfis_ablation_model_manifest_authority(
        model_id=model_id,
        base_seed=base_seed,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    except patch.AnfisAblationModelManifestPatchError as exc:
