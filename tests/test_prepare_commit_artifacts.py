...
def test_closure_phase4_certification_scopes_modes_and_precedence_are_exact(
    ...
    assert (
        ...
        == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V21_STAGED_SCOPE
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V21_STAGED_SCOPE
        == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V20_STAGED_SCOPE
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V20_STAGED_SCOPE
        == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V19_STAGED_SCOPE
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V19_STAGED_SCOPE
        == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V18_STAGED_SCOPE
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V18_STAGED_SCOPE
        == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V17_STAGED_SCOPE
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V17_STAGED_SCOPE
        == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V16_STAGED_SCOPE
    )
    assert list(
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V21_STAGED_SCOPE) == {
        "configs/closure_v1/phase4_final_certification_authority_v21.json",
        "configs/closure_v1/phase4_final_certification_authority_manifest_v21.json",
    }
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V20_STAGED_SCOPE) == {
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V19_STAGED_SCOPE) == {
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V18_STAGED_SCOPE) == {
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V17_STAGED_SCOPE) == {
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V16_STAGED_SCOPE) == {
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V15_STAGED_SCOPE) == {
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V14_STAGED_SCOPE) == {
    ...
    assert (
        precommit_artifacts.CLOSURE_PHASE4_R_CERT_V14_STAGED_SCOPE
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_STAGED_SCOPE
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_R_CERT_V15_STAGED_SCOPE
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_STAGED_SCOPE
    )
    assert (
        contract_module.expected_r15_scope()
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_V15_STAGED_SCOPE
    )
    assert (
        contract_module.expected_r15_modes()
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_V15_GIT_MODES
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_R_CERT_V16_STAGED_SCOPE
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_STAGED_SCOPE
    )
    assert (
        contract_module.expected_r16_scope()
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_V16_STAGED_SCOPE
    )
    assert (
        contract_module.expected_r16_modes()
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_V16_GIT_MODES
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_R_CERT_V17_STAGED_SCOPE
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_STAGED_SCOPE
    )
    assert (
    ...
    assert (
        contract_module.expected_p17_scope()
        == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V17_STAGED_SCOPE
    )
    assert (
    ...
    assert (
        contract_module.expected_h17_modes()
        == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V17_GIT_MODES
    )
    assert (
        contract_module.expected_p17_modes()
        == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V17_GIT_MODES
    )
    assert (
        contract_module.expected_r17_modes()
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_V17_GIT_MODES
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_R_CERT_V18_STAGED_SCOPE
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_STAGED_SCOPE
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_R_CERT_V19_STAGED_SCOPE
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_STAGED_SCOPE
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_R_CERT_V20_STAGED_SCOPE
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_STAGED_SCOPE
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_R_CERT_V21_STAGED_SCOPE
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_STAGED_SCOPE
    )
    assert (
        contract_module.expected_h18_scope()
        == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V18_STAGED_SCOPE
    )
    assert (
        contract_module.expected_p18_scope()
        == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V18_STAGED_SCOPE
    )
    assert (
    ...
    assert (
        contract_module.expected_h18_modes()
        == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V18_GIT_MODES
    )
    assert (
        contract_module.expected_p18_modes()
        == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V18_GIT_MODES
    )
    assert (
        contract_module.expected_r18_modes()
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_V18_GIT_MODES
    )
    assert (
    ...
    assert (
        ...
        == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V19_STAGED_SCOPE
    )
    assert (
    ...
    assert (
        contract_module.expected_h19_modes()
        == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V19_GIT_MODES
    )
    assert (
        contract_module.expected_p19_modes()
        == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V19_GIT_MODES
    )
    assert (
        contract_module.expected_r19_modes()
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_V19_GIT_MODES
    )
    assert (
    ...
    assert (
        ...
        == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V20_STAGED_SCOPE
    )
    assert (
        contract_module.expected_r20_scope()
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_V20_STAGED_SCOPE
    )
    assert (
        contract_module.expected_h20_modes()
        == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V20_GIT_MODES
    )
    assert (
        contract_module.expected_p20_modes()
        == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V20_GIT_MODES
    )
    assert (
        contract_module.expected_r20_modes()
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_V20_GIT_MODES
    )
    assert (
    ...
    assert (
        ...
        == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V21_STAGED_SCOPE
    )
    assert (
    ...
    assert (
        contract_module.expected_h_modes()
        == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V21_GIT_MODES
    )
    assert (
        contract_module.expected_p_modes()
        == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V21_GIT_MODES
    )
    assert (
        contract_module.expected_r_modes()
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_V21_GIT_MODES
    )
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V13_STAGED_SCOPE) == {
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V12_STAGED_SCOPE) == {
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V11_STAGED_SCOPE) == {
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V10_STAGED_SCOPE) == {
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V8_STAGED_SCOPE) == {
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V7_STAGED_SCOPE) == {
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V6_STAGED_SCOPE) == {
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V5_STAGED_SCOPE) == {
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V4_STAGED_SCOPE) == {
    ...
    assert set(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V3_STAGED_SCOPE) == {
    ...
    assert (
        precommit_artifacts.CLOSURE_PHASE4_R_CERT_V13_STAGED_SCOPE
        == precommit_artifacts.CLOSURE_PHASE4_R_CERT_STAGED_SCOPE
    )
    ...
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V5_COMMIT
        == "d18201462be9f6cc057d0187dec2b8b731b62e48"
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_P_CERT_V5_COMMIT
        == "da7b673aa8a7cbdc428ca829e5b9f0a5ac79a3ef"
    )
    assert precommit_artifacts.CLOSURE_PHASE4_P_CERT_V5_BYTES_SHA256 == {
        "configs/closure_v1/phase4_final_certification_authority_v5.json": (
            47_274,
    ...
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V6_COMMIT
        == "a67d58458c1eeb6b38e752dea4eb3bf91ec44ca9"
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_P_CERT_V6_COMMIT
        == "6aea7e7d7908ea0b23dcee41b316759f299114f5"
    )
    assert precommit_artifacts.CLOSURE_PHASE4_P_CERT_V6_BYTES_SHA256 == {
        "configs/closure_v1/phase4_final_certification_authority_v6.json": (
            55_835,
    ...
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V7_COMMIT
        == "67b156d4f5d65ac471597349d20098346e17a736"
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_P_CERT_V7_COMMIT
        == "66505102124082e7926aac58215a0bd35a07ff4b"
    )
    assert precommit_artifacts.CLOSURE_PHASE4_P_CERT_V7_BYTES_SHA256 == {
        "configs/closure_v1/phase4_final_certification_authority_v7.json": (
            61_984,
    ...
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V8_COMMIT
        == "6a339cb7fcec125e379d9829c76e90f5ded55d3a"
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_P_CERT_V8_COMMIT
        == "095b55b208f69936a562eaf09c76fab3389df199"
    )
    assert precommit_artifacts.CLOSURE_PHASE4_P_CERT_V8_BYTES_SHA256 == {
        "configs/closure_v1/phase4_final_certification_authority_v8.json": (
            69_024,
    ...
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V10_COMMIT
        == "825b3382f8d501cbc550bf7738a48d4d489dd5e8"
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_P_CERT_V10_COMMIT
        == "9ca3126667eaa8c4fd754a3499a7a9eacdd2d2b0"
    )
    assert precommit_artifacts.CLOSURE_PHASE4_P_CERT_V10_BYTES_SHA256 == {
        "configs/closure_v1/phase4_final_certification_authority_v10.json": (
            92_421,
    ...
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V11_COMMIT
        == "b83bc2cbccdae5f81bb8ee4b6547054b543260fd"
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_P_CERT_V11_COMMIT
        == "af9e23ec1c21968b0d5bb52821619e21f8de5673"
    )
    assert precommit_artifacts.CLOSURE_PHASE4_P_CERT_V11_BYTES_SHA256 == {
        "configs/closure_v1/phase4_final_certification_authority_v11.json": (
            101_492,
    ...
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V12_COMMIT
        == "bc5595bfca0e39cd3912f6b786442580d5c1a9fe"
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_P_CERT_V12_COMMIT
        == "f97e0a5cf21aa9b65623cee0a8a656ab0537e2ad"
    )
    assert precommit_artifacts.CLOSURE_PHASE4_P_CERT_V12_BYTES_SHA256 == {
        "configs/closure_v1/phase4_final_certification_authority_v12.json": (
            111_368,
    ...
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V15_COMMIT
        == "13640203e1c95d5ae9f8861fec3e6c842d90c545"
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_P_CERT_V15_COMMIT
        == "fa00bbd07d47ff504f2323e418934824efab386a"
    )
    assert precommit_artifacts.CLOSURE_PHASE4_P_CERT_V15_BYTES_SHA256 == {
        "configs/closure_v1/phase4_final_certification_authority_v15.json": (
            130_583,
        ...
        (
            "configs/closure_v1/"
            "phase4_final_certification_authority_manifest_v15.json"
        ): (
            3_494,
    ...
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V16_COMMIT
        == "4f78e7d1a8f93eedda169c5499c331b8da15de1e"
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_P_CERT_V16_COMMIT
        == "6c5fbaac2bf48393b3e7ef3e24d95006ecc016b9"
    )
    assert precommit_artifacts.CLOSURE_PHASE4_P_CERT_V16_BYTES_SHA256 == {
        "configs/closure_v1/phase4_final_certification_authority_v16.json": (
            142_014,
        ...
        (
            "configs/closure_v1/"
            "phase4_final_certification_authority_manifest_v16.json"
        ): (
            3_638,
    ...
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V17_COMMIT
        == "a7e4f10321c8ea8321d0c4917969ecc9ab39f59b"
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_P_CERT_V17_COMMIT
        == "1677778862786d28b9f60e80b7e718432e0b0947"
    )
    assert precommit_artifacts.CLOSURE_PHASE4_P_CERT_V17_BYTES_SHA256 == {
        "configs/closure_v1/phase4_final_certification_authority_v17.json": (
            154_137,
        ...
        (
            "configs/closure_v1/"
            "phase4_final_certification_authority_manifest_v17.json"
        ): (
            3_782,
    ...
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V18_COMMIT
        == "b5c6b837bedd3ec66eb4a431fe631e53f2d72ed2"
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_P_CERT_V18_COMMIT
        == "da0e1908c25811b3e0fca08145fc517591b495b3"
    )
    assert precommit_artifacts.CLOSURE_PHASE4_P_CERT_V18_BYTES_SHA256 == {
        "configs/closure_v1/phase4_final_certification_authority_v18.json": (
            166_277,
            "a2daa619a6710e6aa711e3dbc61c4130bf6853cccf0c139f2eb0336146a09e33",
        ),
        (
            "configs/closure_v1/"
            "phase4_final_certification_authority_manifest_v18.json"
        ): (
            3_926,
    ...
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V19_COMMIT
        == "f5184778a732fdb7677e3ab9b906b72328509ed1"
    )
    assert precommit_artifacts.CLOSURE_PHASE4_P_CERT_V19_COMMIT is None
    assert (
        precommit_artifacts.CLOSURE_PHASE4_H_CERT_V20_COMMIT
        == "1e59a4af6d4fb1af1c8c6161366fa70c01ab945e"
    )
    assert (
        precommit_artifacts.CLOSURE_PHASE4_P_CERT_V20_COMMIT
        == "c61cd14d4bb78a2bf1bc1c5c79aa83a814d01468"
    )
    assert precommit_artifacts.CLOSURE_PHASE4_P_CERT_V20_BYTES_SHA256 == {
        "configs/closure_v1/phase4_final_certification_authority_v20.json": (
            182_108,
        ...
        (
            "configs/closure_v1/"
            "phase4_final_certification_authority_manifest_v20.json"
        ): (
            4_198,
            "b639f9b021e603849e11c31f8988d90dcbbbf17a6133a8db010dc9bb30ebf8e3",
        ),
    }
    assert contract_module.LOCKED_SUITE_NODEIDS_SHA256 == (
        "255beb8438b402199251e435c4d450d9f4d5a9e30aac06216f5daf526327a296"
    )
    assert contract_module.LOCKED_SUITE_COLLECTED_TEST_COUNT == 944
    assert contract_module.LOCKED_SUITE_ALLOWED_SKIP_COUNT == 42
    assert contract_module.LOCKED_SUITE_SELECTOR_COUNT == 39
    h13_failure = contract_module.expected_h13_failure_record()
    assert h13_failure["attempt"] == "H-CERT13"
    assert h13_failure["retry_authorized"] is False
    assert h13_failure["active_error"]["returncode"] == 0
    assert h13_failure["active_error"]["safe_stdout_category"] == (
        "empty_json_object"
    )
    assert h13_failure["observed_cause"]["stdout_semantic"] == {}
    assert h13_failure["observed_cause"][
        "public_git_worktree_index_change_attributable"
    ] is False
    assert h13_failure["observed_cause"][
        "ignored_dvc_metadata_mutation_assessed"
    ] is False
    assert h13_failure["evidence_counts"]["h13_check_only_runs"] == 3
    assert h13_failure["evidence_counts"]["h13_precommit_invocations"] == 3
    assert h13_failure["evidence_counts"]["h13_precommit_passes"] == 2
    assert h13_failure["evidence_counts"]["h13_precommit_rejections"] == 1
    assert h13_failure["evidence_counts"]["git_restore_staged_invocations"] == 2
    assert h13_failure["evidence_counts"]["manual_main_dvc_status_commands"] == 1
    h13_failure["retry_authorized"] = True
    with monkeypatch.context() as patch:
        ...
        with pytest.raises(
            ...
            match="H-CERT13 factual/no-retry policy drifted",
        ):
    ...
    assert p19_failure["active_error"]["shared_values_equal"] is True
    assert p19_failure["candidate_authority"] == {
    ...
    assert p19_failure["cleanup"]["candidate_archived_under_ignored_tmp"] is True
    assert p19_failure["cleanup"]["archive_path_or_run_id_serialized"] is False
    assert p19_failure["evidence_counts"] == {
    ...
    drifted_p19_failure = deepcopy(p19_failure)
    drifted_p19_failure["retry_authorized"] = True
    with monkeypatch.context() as patch:
        patch.setattr(
            contract_module,
            "expected_p19_failure_record",
            lambda: drifted_p19_failure,
        )
        with pytest.raises(
            precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
            match="P-CERT19 factual/no-retry policy drifted",
        ):
            precommit_artifacts._require_closure_phase4_cert_contract(
                repo_root=Path(".")
            )
    ...
    drifted_r20_failure = deepcopy(r20_failure)
    drifted_r20_failure["retry_authorized"] = True
    with monkeypatch.context() as patch:
        patch.setattr(
            contract_module,
            "expected_r20_failure_record",
            lambda: drifted_r20_failure,
        )
        with pytest.raises(
            precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
            match="R-CERT20 factual/no-retry policy drifted",
        ):
            precommit_artifacts._require_closure_phase4_cert_contract(
                repo_root=Path(".")
            )
    p16_failure = contract_module.expected_p16_failure_record()
    p16_public_failure = p16_failure["active_error"]["public_tests_failure"]
    assert p16_failure["attempt"] == "R-CERT16"
    assert p16_failure["retry_authorized"] is False
    assert p16_public_failure["totals"] == {}
    assert p16_public_failure["collected_test_count"] is None
    assert p16_public_failure["collected_nodeids_sha256"] is None
    assert p16_public_failure["failed_nodeids"] == []
    assert p16_public_failure["error_nodeids"] == []
    assert p16_public_failure["failed_nodeids_sha256"] == (
        "37517e5f3dc66819f61f5a7bb8ace1921282415f10551d2defa5c3eb0985b570"
    )
    assert p16_public_failure["error_nodeids_sha256"] == (
        "37517e5f3dc66819f61f5a7bb8ace1921282415f10551d2defa5c3eb0985b570"
    )
    assert p16_public_failure["unavailable_reason"] == (
        "junit_malformed_or_hostile"
    )
    assert all(
        p16_public_failure[key] is False
        for key in (
            "messages_preserved",
    ...
    drifted_p16_failure = deepcopy(p16_failure)
    drifted_p16_failure["active_error"]["public_tests_failure"]["totals"] = {
        "tests": 944
    }
    with monkeypatch.context() as patch:
        patch.setattr(
            ...
            lambda: drifted_p16_failure,
        )
        with pytest.raises(
            precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
            match="P-CERT16 execution/no-retry policy drifted",
        ):
            precommit_artifacts._require_closure_phase4_cert_contract(
                repo_root=Path(".")
            )
    p17_failure = contract_module.expected_p17_failure_record()
    p17_public_failure = p17_failure["active_error"]["public_tests_failure"]
    assert p17_failure["attempt"] == "R-CERT17"
    assert p17_failure["status"] == "execution_failed_closed_cleanup_succeeded"
    assert p17_failure["retry_authorized"] is False
    assert p17_public_failure["status"] == "failure_identity_available"
    assert p17_public_failure["totals"] == {
        "tests": 944,
        "passed": 895,
        "failures": 7,
        "errors": 0,
    ...
    assert len(p17_public_failure["failed_nodeids"]) == 7
    assert p17_public_failure["failed_nodeids_sha256"] == (
        "e328bbeea535afadf98704170520cc4c38d660b7b89dee32fdbf9ba5ab776eb6"
    )
    assert p17_public_failure["error_nodeids"] == []
    assert p17_public_failure["error_nodeids_sha256"] == (
        "37517e5f3dc66819f61f5a7bb8ace1921282415f10551d2defa5c3eb0985b570"
    )
    assert p17_public_failure["collected_test_count"] == 944
    assert p17_public_failure["collected_nodeids_sha256"] == (
        "8422082eca90068bf6d6fff4f1e4d9b9964535e12c8fd6b0844658bbdf683349"
    )
    assert p17_failure["observed_cause"]["safe_error"] == (
        "retained_sandbox_python_alias_rejected"
    )
    assert p17_failure["cleanup"]["status"] == "succeeded_exact"
    assert p17_failure["cleanup"]["namespace_preserved"] is False
    assert p17_failure["evidence_counts"]["r_cert_outputs"] == 0
    drifted_p17_failure = deepcopy(p17_failure)
    drifted_p17_failure["retry_authorized"] = True
    with monkeypatch.context() as patch:
        patch.setattr(
            contract_module,
            "expected_p17_failure_record",
            lambda: drifted_p17_failure,
        )
        with pytest.raises(
            precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
            match="P-CERT17 execution/no-retry policy drifted",
        ):
            precommit_artifacts._require_closure_phase4_cert_contract(
                repo_root=Path(".")
            )
    ...
    p18_cause = p18_failure["observed_cause"]
    assert p18_cause["classification"] == "representation_guard_false_positive"
    assert p18_cause["trigger"] == (
        "sealed_fixture_marker_in_canonical_junit_identity"
    )
    assert p18_cause["operational_url_or_credential_exposed"] is False
    assert p18_cause["historical_marker_bearing_nodeid_count"] == 5
    assert p18_cause["historical_marker_bearing_nodeids_sha256"] == (
    ...
    assert "historical_marker_bearing_nodeids_serialized" not in p18_cause
    assert p18_cause["sealed_suite_nodeids_sha256"] == (
        contract_module.HISTORICAL_LOCKED_SUITE_NODEIDS_SHA256
    )
    assert p18_cause["sealed_suite_nodeids_sha256"] != (
        contract_module.LOCKED_SUITE_NODEIDS_SHA256
    )
    assert p18_cause["public_test_totals"] == {
        "tests": 944,
        "passed": 902,
        "failures": 0,
        "errors": 0,
    ...
    redaction_policy = contract_module.expected_public_junit_redaction_policy()
    assert redaction_policy[
        "historical_marker_bearing_nodeids_preserved_or_published"
    ] is False
    assert "historical_marker_bearing_nodeids_serialized" not in redaction_policy
    drifted_p18_failure = deepcopy(p18_failure)
    drifted_p18_failure["retry_authorized"] = True
    with monkeypatch.context() as patch:
        patch.setattr(
            contract_module,
            "expected_p18_failure_record",
            lambda: drifted_p18_failure,
        )
        with pytest.raises(
            precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
            match="P-CERT18 execution/no-retry policy drifted",
        ):
            precommit_artifacts._require_closure_phase4_cert_contract(
                repo_root=Path(".")
            )
    p14_failure = contract_module.expected_p14_failure_record()
    operator_diagnostic = p14_failure["operator_diagnostic"]
    assert operator_diagnostic["stage"] == "wrong_locker_check_only_invocation"
    assert operator_diagnostic["returncode"] == 2
    assert operator_diagnostic["read_only"] is True
    assert operator_diagnostic["used_as_authority"] is False
    assert p14_failure["evidence_counts"][
        "wrong_locker_check_only_invocations"
    ] == 1
    drifted_p14_failure = deepcopy(p14_failure)
    drifted_p14_failure["operator_diagnostic"]["sanitized_command"][-1] = (
        "--generate"
    )
    with monkeypatch.context() as patch:
        patch.setattr(
            ...
            lambda: drifted_p14_failure,
        )
        with pytest.raises(
            precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
            match="P-CERT14 preflight/no-retry policy drifted",
        ):
            precommit_artifacts._require_closure_phase4_cert_contract(
                repo_root=Path(".")
            )
    ...
    assert p15_failure["active_error"]["stage"] == "public_tests"
    assert p15_failure["active_error"]["returncode"] == 1
    assert p15_failure["observed_cause"]["underlying_cause_known"] is False
    assert p15_failure["cleanup"]["status"] == "succeeded_exact"
    assert p15_failure["cleanup"]["namespace_preserved"] is False
    ...
    drifted_p15_failure = deepcopy(p15_failure)
    drifted_p15_failure["observed_cause"]["underlying_cause_known"] = True
    with monkeypatch.context() as patch:
        patch.setattr(
            contract_module,
            "expected_p15_failure_record",
            lambda: drifted_p15_failure,
        )
        with pytest.raises(
            precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
            match="P-CERT15 execution/no-retry policy drifted",
        ):
            precommit_artifacts._require_closure_phase4_cert_contract(
                repo_root=Path(".")
            )
    ...
    assert p8_failure["cleanup"]["namespace_preserved"] is True
    assert p8_failure["cleanup"]["status"] == "failed_closed"
    assert (
        precommit_artifacts._require_closure_phase4_cert_contract(
            repo_root=Path(".")
        ).p8_cert_commit
    ...
    p8_failure["retry_authorized"] = True
    with monkeypatch.context() as patch:
        patch.setattr(
            contract_module,
        ...
        with pytest.raises(
            precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
            match="P-CERT8 failure/retry policy drifted",
        ):
            precommit_artifacts._require_closure_phase4_cert_contract(
                repo_root=Path(".")
            )
    ...
    assert p11_failure["cleanup"]["status"] == "succeeded_exact"
    assert p11_failure["cleanup"]["namespace_preserved"] is False
    assert p11_failure["observed_cause"]["helper_operation"] == (
        "string_rsplit_last_slash"
    )
    assert p11_failure["observed_cause"]["configured_database_name"] == (
        "closure_phase4_cert"
    )
    assert p11_failure["observed_cause"]["derived_database_name"] == "cert-db"
    p11_failure["retry_authorized"] = True
    with monkeypatch.context() as patch:
        patch.setattr(
            contract_module,
        ...
        with pytest.raises(
            precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
            match="P-CERT11 failure/retry policy drifted",
        ):
            precommit_artifacts._require_closure_phase4_cert_contract(
                repo_root=Path(".")
            )
    ...
    assert p12_failure["cleanup"]["status"] == "succeeded_exact"
    assert p12_failure["cleanup"]["namespace_preserved"] is False
    assert p12_failure["observed_cause"]["successful_readiness_probes"] == 1
    assert p12_failure["observed_cause"]["socket_claims_captured"] == 0
    p12_failure["retry_authorized"] = True
    with monkeypatch.context() as patch:
        patch.setattr(
            contract_module,
        ...
        with pytest.raises(
            precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
            match="P-CERT12 failure/retry policy drifted",
        ):
            precommit_artifacts._require_closure_phase4_cert_contract(
                repo_root=Path(".")
            )
    ...
    assert p10_failure["observed_cause"]["observed_collected_test_count"] == 946
    assert p10_failure["observed_cause"]["observed_nodeids_sha256"] == (
        "644bc8548b730c98a62773dcc01622a6d5322ffabbcc31aa0e63b12275df9295"
    )
    p10_failure["retry_authorized"] = True
    with monkeypatch.context() as patch:
        patch.setattr(
            contract_module,
        ...
        with pytest.raises(
            precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
            match="P-CERT10 failure/retry policy drifted",
        ):
            precommit_artifacts._require_closure_phase4_cert_contract(
                repo_root=Path(".")
            )
    ...
    assert junit_policy["enabled_on_nonzero_exit"] is True
    assert junit_policy["require_success"] is False
    assert junit_policy["max_junit_bytes"] == 16_777_216
    assert junit_policy["available_status"] == "failure_identity_available"
    assert junit_policy["unavailable_status"] == "failure_identity_unavailable"
    assert junit_policy["exact_skip_override_marker"] == "skipif_true"
    assert junit_policy["exact_skip_override_prepend"] is True
    assert junit_policy["preexisting_skipif_precedence_neutralized"] is True
    assert junit_policy["raw_skip_reason_alias_count"] == 5
    assert len(junit_policy["raw_skip_reason_aliases"]) == 5
    assert set(junit_policy["raw_skip_reason_aliases"]) == {
        (
            "tests/test_audit_closure_p0_sequence_bundle.py::"
            "test_real_p0_physical_schema_matches_closed_fields"
        ),
        (
            "tests/test_audit_closure_p0_sequence_bundle.py::"
            "test_real_p0_audit_failure_is_read_only[early]"
        ),
        (
            "tests/test_audit_closure_p0_sequence_bundle.py::"
            "test_real_p0_audit_failure_is_read_only[late]"
        ),
        (
            "tests/test_audit_closure_p0_sequence_bundle.py::"
            "test_real_p0_audit_pass_is_read_only"
        ),
        (
            "tests/test_audit_closure_p0_sequence_bundle.py::"
            "test_real_p0_cli_is_repeatable_and_read_only"
        ),
    }
    assert set(junit_policy["raw_skip_reason_aliases"].values()) == {
    ...
    assert junit_policy["duplicate_testcase_pair_max_records"] == 2
    assert junit_policy["duplicate_testcase_pair_exact_outcomes"] == [
        "failure",
        "error",
    ]
    assert junit_policy[
    ...
    assert junit_policy["declared_tests_minimum"] == (
        "logical_testcase_identity_count"
    )
    assert junit_policy["declared_tests_maximum"] == (
        "logical_testcase_identity_count_plus_error_identity_count"
    )
    assert junit_policy["declared_failures_errors_skipped_exact"] is True
    assert junit_policy["messages_serialized"] is False
    assert junit_policy["tracebacks_serialized"] is False
    assert junit_policy["raw_junit_serialized"] is False
    assert junit_policy["credentials_serialized"] is False
    locked_contract = contract_module.load_contract(
        root=Path("."),
        verify_inputs=True,
        allow_pending_suite=False,
    )
    drifted_junit_policy = deepcopy(junit_policy)
    drifted_junit_policy["max_junit_bytes"] += 1
    with monkeypatch.context() as patch:
        patch.setattr(
            contract_module,
            "load_contract",
            lambda **_kwargs: locked_contract,
        )
        patch.setattr(
            contract_module,
            "expected_public_tests_junit_diagnostic_policy",
            lambda: drifted_junit_policy,
        )
        with pytest.raises(
            precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
            match="public-tests JUnit diagnostic policy drifted",
        ):
            precommit_artifacts._require_closure_phase4_cert_contract(
                repo_root=Path(".")
            )
    ...
    assert contract_module.expected_postgres_connection_policy() == {
...
def test_closure_phase4_h_cert_selector_is_exact_and_rejects_guard_extra_pending(
    ...
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_cert_v20_history",
        lambda **_kwargs: None,
    )
    monkeypatch.setattr(
        precommit_artifacts,
    ...
    invalid_p19_path = next(
        iter(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V19_STAGED_SCOPE)
    )
    with pytest.raises(
        precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
        match="reject invalid P-CERT19",
    ):
    ...
    with pytest.raises(
        ...
        precommit_artifacts.closure_phase4_p_cert_pre_stage_scope(
            "",
            f"A\t{invalid_p19_path}\n",
            repo_root=tmp_path,
        )
    with pytest.raises(
        precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
...
def test_closure_phase4_h_cert4_selector_rejects_superseded_base(
    tmp_path: Path, monkeypatch
) -> None:
    (tmp_path / "tmp").mkdir()
...
def test_closure_phase4_p_cert4_selector_accepts_git_lexical_status_order(
    tmp_path: Path, monkeypatch
) -> None:
    (tmp_path / "tmp").mkdir()
    lines = _phase4_cert_short_status("P-CERT", staged=False).splitlines()
    assert lines[0].endswith("authority_manifest_v21.json")
    assert lines[1].endswith("authority_v21.json")
    reversed_status = "\n".join(reversed(lines)) + "\n"
    h3_commit = "a" * 40
    observed: list[str] = []
    monkeypatch.setattr(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V3_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V3_STAGED_SCOPE,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V3_GIT_MODES,
            "P-CERT3",
            "_require_closure_phase4_p3_files_intact",
        ),
    ],
)
...
def test_closure_phase4_cert_v2_history_binds_exact_topology_and_scopes(
    ...
    parents.update(
        {
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V5_COMMIT: (
                precommit_artifacts.CLOSURE_PHASE4_P_CERT_V4_COMMIT,
            ),
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V5_COMMIT: (
                precommit_artifacts.CLOSURE_PHASE4_H_CERT_V5_COMMIT,
            ),
    ...
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_cert_v4_history",
        lambda **_kwargs: None,
    )

    def intact_p5(**_kwargs: Any) -> None:
        nonlocal p5_intact
        p5_intact += 1

    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_p5_files_intact",
        intact_p5,
    )
    precommit_artifacts._require_closure_phase4_cert_v5_history(
        repo_root=Path(".")
    )
    assert observed == [
        (
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V5_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V5_STAGED_SCOPE,
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V5_GIT_MODES,
            "H-CERT5",
        ),
        (
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V5_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V5_STAGED_SCOPE,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V5_GIT_MODES,
            "P-CERT5",
        ),
    ]
    assert p5_intact == 1
    ...
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_cert_v5_history",
        lambda **_kwargs: None,
    )

    def intact_p6(**_kwargs: Any) -> None:
        nonlocal p6_intact
        p6_intact += 1

    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_p6_files_intact",
        intact_p6,
    )
    precommit_artifacts._require_closure_phase4_cert_v6_history(
        repo_root=Path(".")
    )
    assert observed == [
        (
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V6_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V6_STAGED_SCOPE,
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V6_GIT_MODES,
            "H-CERT6",
        ),
        (
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V6_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V6_STAGED_SCOPE,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V6_GIT_MODES,
            "P-CERT6",
        ),
    ]
    assert p6_intact == 1
    ...
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_cert_v6_history",
        lambda **_kwargs: None,
    )

    def intact_p7(**_kwargs: Any) -> None:
        nonlocal p7_intact
        p7_intact += 1

    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_p7_files_intact",
        intact_p7,
    )
    precommit_artifacts._require_closure_phase4_cert_v7_history(
        repo_root=Path(".")
    )
    assert observed == [
        (
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V7_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V7_STAGED_SCOPE,
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V7_GIT_MODES,
            "H-CERT7",
        ),
        (
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V7_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V7_STAGED_SCOPE,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V7_GIT_MODES,
            "P-CERT7",
        ),
    ]
    assert p7_intact == 1
    ...
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_cert_v7_history",
        lambda **_kwargs: None,
    )

    def intact_p8(**_kwargs: Any) -> None:
        nonlocal p8_intact
        p8_intact += 1

    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_p8_files_intact",
        intact_p8,
    )
    precommit_artifacts._require_closure_phase4_cert_v8_history(
        repo_root=Path(".")
    )
    assert observed == [
        (
            ...
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V8_GIT_MODES,
            "H-CERT8",
        ),
        (
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V8_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V8_STAGED_SCOPE,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V8_GIT_MODES,
            "P-CERT8",
        ),
    ]
    assert p8_intact == 1
    ...
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_cert_v10_history",
        lambda **_kwargs: None,
    )

    def intact_p11(**_kwargs: Any) -> None:
        nonlocal p11_intact
        p11_intact += 1

    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_p11_files_intact",
        intact_p11,
    )
    precommit_artifacts._require_closure_phase4_cert_v11_history(
        repo_root=Path(".")
    )
    assert observed == [
        (
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V11_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V11_STAGED_SCOPE,
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V11_GIT_MODES,
            "H-CERT11",
        ),
        (
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V11_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V11_STAGED_SCOPE,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V11_GIT_MODES,
            "P-CERT11",
        ),
    ]
    assert p11_intact == 1
    ...
    observed.clear()
    p12_intact: list[bool] = []
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_cert_v11_history",
        lambda **_kwargs: None,
    )
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_p12_files_intact",
        lambda **_kwargs: p12_intact.append(True),
    )
    precommit_artifacts._require_closure_phase4_cert_v12_history(
        repo_root=Path(".")
    )
    assert observed == [
        (
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V12_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V12_STAGED_SCOPE,
            precommit_artifacts.CLOSURE_PHASE4_H_CERT_V12_GIT_MODES,
            "H-CERT12",
        ),
        (
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V12_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V12_STAGED_SCOPE,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V12_GIT_MODES,
            "P-CERT12",
        ),
    ]
    assert p12_intact == [True]
    ...
    observed.clear()
    p17_intact: list[bool] = []
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_cert_v16_history",
        lambda **_kwargs: None,
    )
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_p17_files_intact",
        lambda **_kwargs: p17_intact.append(True),
    )
    precommit_artifacts._require_closure_phase4_cert_v17_history(
        repo_root=Path(".")
    )
    assert observed == [
        (
    ...
    observed.clear()
    p18_intact: list[bool] = []
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_cert_v17_history",
        lambda **_kwargs: None,
    )
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_p18_files_intact",
        lambda **_kwargs: p18_intact.append(True),
    )
    precommit_artifacts._require_closure_phase4_cert_v18_history(
        repo_root=Path(".")
    )
    assert observed == [
        (
    ...
    assert p18_intact == [True]

    parents[precommit_artifacts.CLOSURE_PHASE4_H_CERT_V19_COMMIT] = (
        precommit_artifacts.CLOSURE_PHASE4_P_CERT_V18_COMMIT,
    )
    observed.clear()
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_cert_v18_history",
        lambda **_kwargs: None,
    )
    precommit_artifacts._require_closure_phase4_cert_v19_history(
        repo_root=Path(".")
    )
    assert observed == [
        (
    ...
    observed.clear()
    p20_intact: list[bool] = []
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_cert_v19_history",
        lambda **_kwargs: None,
    )
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_p20_files_intact",
        lambda **_kwargs: p20_intact.append(True),
    )
    precommit_artifacts._require_closure_phase4_cert_v20_history(
        repo_root=Path(".")
    )
    assert observed == [
        (
...
def test_closure_phase4_cert_historical_p_cannot_authorize_r_cert(
    ...
    def parents(commit: str, **_kwargs: Any) -> tuple[str, ...]:
        ...
        if commit == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V3_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_H_CERT_V3_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V3_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_P_CERT_V2_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V4_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_H_CERT_V4_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V4_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_P_CERT_V3_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V5_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_H_CERT_V5_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V5_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_P_CERT_V4_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V6_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_H_CERT_V6_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V6_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_P_CERT_V5_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V7_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_H_CERT_V7_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V7_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_P_CERT_V6_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V8_COMMIT:
        ...
        if commit == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V10_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_H_CERT_V10_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V10_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_P_CERT_V9_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V11_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_H_CERT_V11_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V11_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_P_CERT_V10_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V12_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_H_CERT_V12_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V12_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_P_CERT_V11_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V14_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_H_CERT_V14_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V14_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_P_CERT_V12_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V15_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_H_CERT_V15_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V15_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_P_CERT_V14_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V16_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_H_CERT_V16_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V16_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_P_CERT_V15_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V17_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_H_CERT_V17_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V17_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_P_CERT_V16_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V18_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_H_CERT_V18_COMMIT,)
        if commit == precommit_artifacts.CLOSURE_PHASE4_H_CERT_V18_COMMIT:
            return (precommit_artifacts.CLOSURE_PHASE4_P_CERT_V17_COMMIT,)
    ...
    if p_commit == precommit_artifacts.CLOSURE_PHASE4_P_CERT_V1_COMMIT:
        for later_historical_p in (
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V4_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V5_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V6_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V7_COMMIT,
            ...
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V11_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V12_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V14_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V15_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V16_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V17_COMMIT,
            precommit_artifacts.CLOSURE_PHASE4_P_CERT_V18_COMMIT,
...
def test_closure_phase4_cert_rejects_runtime_authority_and_cleanup_namespaces(
    ...
    for label, scope in (
        ...
        ("P3", precommit_artifacts.CLOSURE_PHASE4_P_CERT_V3_STAGED_SCOPE),
        ("P4", precommit_artifacts.CLOSURE_PHASE4_P_CERT_V4_STAGED_SCOPE),
        ("P5", precommit_artifacts.CLOSURE_PHASE4_P_CERT_V5_STAGED_SCOPE),
        ("P6", precommit_artifacts.CLOSURE_PHASE4_P_CERT_V6_STAGED_SCOPE),
    ):
    ...
    invalid_p19 = (
        tmp_path
        / next(iter(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V19_STAGED_SCOPE))
    )
    invalid_p19.write_text("invalid unpublished\n", encoding="utf-8")
    with pytest.raises(
        precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
        match="invalid unpublished P-CERT19",
    ):
        precommit_artifacts._require_closure_phase4_cert_runtime_namespaces(
            "P-CERT", repo_root=tmp_path
        )
    invalid_p19.unlink()
    ...
    failed_candidate = (
        tmp_path
        / next(iter(precommit_artifacts.CLOSURE_PHASE4_P_CERT_V13_STAGED_SCOPE))
    )
    failed_candidate.write_text("ungenerated\n", encoding="utf-8")
    with pytest.raises(
        precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
        match="ungenerated P-CERT13",
    ):
        precommit_artifacts._require_closure_phase4_cert_runtime_namespaces(
            "H-CERT", repo_root=tmp_path
        )
...
def test_closure_phase4_cert_staged_double_recapture_rejects_semantic_drift(
    ...
    monkeypatch.setattr(
        precommit_artifacts,
        "_git_output",
        lambda *_args: precommit_artifacts.CLOSURE_PHASE4_P_CERT_V20_COMMIT,
    )
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_cert_v20_history",
...
def test_closure_phase4_p_cert_semantic_digest_requires_exact_reconstruction(
    ...
    contract = SimpleNamespace(
        test_suite=SimpleNamespace(status="locked"),
        dvc_pointer_paths=pointer_paths,
    ...
    authority = {
        ...
        "status": "locked_unpublished",
        "topology": {
            "h19_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V19_COMMIT,
            "p19_cert_commit": None,
            "h20_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V20_COMMIT,
            "p20_cert_commit": precommit_artifacts.CLOSURE_PHASE4_P_CERT_V20_COMMIT,
        ...
        "p19_failure": contract_module.expected_p19_failure_record(),
        "r20_failure": contract_module.expected_r20_failure_record(),
        "public_junit_redaction_policy": redaction_policy,
        "isolation": {"public_junit_redaction_policy": redaction_policy},
    }
    manifest = {
        "gate": "P-CERT",
        "status": "locked_unpublished",
    ...
    validated: list[Any] = []
    independent_authorities: list[str] = []
    independent_manifests: list[str] = []
    monkeypatch.setattr(
        precommit_artifacts,
        "_require_closure_phase4_cert_contract",
    ...
    monkeypatch.setattr(
        ...
        lambda *_args, **_kwargs: (
            independent_authorities.append("authority") or authority
        ),
    )
    monkeypatch.setattr(
        contract_module,
        "_expected_effective_manifest",
        lambda *_args, **_kwargs: (
            independent_manifests.append("manifest") or manifest
        ),
    )
    monkeypatch.setattr(
        precommit_artifacts,
    ...
    assert independent_authorities == ["authority"]
    assert independent_manifests == ["manifest"]
    ...
    with pytest.raises(
        precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
        match="differs from exact independent canonical",
    ):
    ...
    locker_projection_without_policy = deepcopy(authority)
    del locker_projection_without_policy["public_junit_redaction_policy"]
    monkeypatch.setattr(
        locker,
        "_build_authority",
        lambda *_args: locker_projection_without_policy,
    )
    with pytest.raises(
        precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
        match="locker authority differs from independent contract",
    ):
        precommit_artifacts._closure_phase4_cert_semantic_digest(
            "P-CERT", repo_root=Path(".")
        )
    ...
    monkeypatch.setattr(locker, "_build_authority", lambda *_args: authority)
    contract_projection_without_policy = deepcopy(authority)
    del contract_projection_without_policy["public_junit_redaction_policy"]
    expected[contract_module.AUTHORITY_PATH.as_posix()] = (
        contract_module.canonical_json_bytes(contract_projection_without_policy)
    )
    monkeypatch.setattr(
        locker,
        "_build_authority",
        lambda *_args: contract_projection_without_policy,
    )
    monkeypatch.setattr(
        contract_module,
        "_expected_effective_authority",
        lambda *_args, **_kwargs: contract_projection_without_policy,
    )
    with pytest.raises(
        precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
        match="not canonical, policy-complete, or factually bound",
    ):
        precommit_artifacts._closure_phase4_cert_semantic_digest(
            "P-CERT", repo_root=Path(".")
        )
    ...
    monkeypatch.setattr(
        locker,
        "_build_manifest",
        lambda *_args: {**manifest, "manifest_last": False},
    )
    with pytest.raises(
        precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
        match="locker companion differs from independent contract",
    ):
        precommit_artifacts._closure_phase4_cert_semantic_digest(
            "P-CERT", repo_root=Path(".")
        )
...
def test_closure_phase4_h_cert_semantic_digest_requires_read_only_h3_preflight(
    ...
    result = {
        ...
        "h3_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V3_COMMIT,
        "p3_cert_commit": precommit_artifacts.CLOSURE_PHASE4_P_CERT_V3_COMMIT,
        "h4_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V4_COMMIT,
        "p4_cert_commit": precommit_artifacts.CLOSURE_PHASE4_P_CERT_V4_COMMIT,
        "h5_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V5_COMMIT,
        "p5_cert_commit": precommit_artifacts.CLOSURE_PHASE4_P_CERT_V5_COMMIT,
        "h6_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V6_COMMIT,
        "p6_cert_commit": precommit_artifacts.CLOSURE_PHASE4_P_CERT_V6_COMMIT,
        "h7_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V7_COMMIT,
        ...
        "h10_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V10_COMMIT,
        "p10_cert_commit": precommit_artifacts.CLOSURE_PHASE4_P_CERT_V10_COMMIT,
        "h11_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V11_COMMIT,
        "p11_cert_commit": precommit_artifacts.CLOSURE_PHASE4_P_CERT_V11_COMMIT,
        "h12_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V12_COMMIT,
        "p12_cert_commit": precommit_artifacts.CLOSURE_PHASE4_P_CERT_V12_COMMIT,
        "h_cert_commit": None,
        "h13_cert_commit": None,
        "p13_cert_commit": None,
        "h14_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V14_COMMIT,
        "p14_cert_commit": precommit_artifacts.CLOSURE_PHASE4_P_CERT_V14_COMMIT,
        "h15_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V15_COMMIT,
        "p15_cert_commit": precommit_artifacts.CLOSURE_PHASE4_P_CERT_V15_COMMIT,
        "h16_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V16_COMMIT,
        "p16_cert_commit": precommit_artifacts.CLOSURE_PHASE4_P_CERT_V16_COMMIT,
        "h17_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V17_COMMIT,
        "p17_cert_commit": precommit_artifacts.CLOSURE_PHASE4_P_CERT_V17_COMMIT,
        "h18_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V18_COMMIT,
        "p18_cert_commit": precommit_artifacts.CLOSURE_PHASE4_P_CERT_V18_COMMIT,
        "h19_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V19_COMMIT,
        "p19_cert_commit": None,
        "h20_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V20_COMMIT,
        "p20_cert_commit": precommit_artifacts.CLOSURE_PHASE4_P_CERT_V20_COMMIT,
        "h21_cert_commit": None,
        "p21_cert_commit": None,
        "p_cert_commit": None,
        "writes_performed": False,
...
def test_closure_phase4_cert_rollback_is_parent_directed_and_preserves_foreign(
    ...
    monkeypatch.setattr(
        ...
        lambda *_args, **_kwargs: "static-boundary",
    )
    assert (
        precommit_artifacts._rollback_closure_phase4_cert_staging(
            ...
            static_boundary_before="static-boundary",
            repo_root=Path("."),
...
@pytest.mark.parametrize(
    "boundary",
    ("semantic", "index", "status", "remote", "pointers"),
)
...
def test_closure_phase4_cert_runner_rejects_parent_swap_at_external_boundaries(
    ...
    if boundary == "semantic":
        ...
        monkeypatch.setattr(
            precommit_artifacts,
            "_closure_phase4_cert_static_git_pointer_boundary",
            lambda *_args, **_kwargs: (swap_parent() or "static-boundary"),
        )
...
def test_closure_phase4_cert_static_pointer_boundary_never_launches_dvc(
    monkeypatch,
) -> None:
    from src.reporting import phase4_final_certification_contract as contract_module

    pointer_paths = tuple(f"data/pointer-{index}.parquet.dvc" for index in range(8))
    contract = SimpleNamespace(
        dvc_pointers=tuple(SimpleNamespace(path=path) for path in pointer_paths)
    )
    pointer_records = [
        {"path": path, "sha256": f"{index:064x}"}
        for index, path in enumerate(pointer_paths)
    ]
    dirty = False
    ...
    def git_output(_root: Path, *args: str) -> str:
        ...
        if args[:2] == ("ls-files", "-s"):
            return "\n".join(
                f"100644 {index + 1:040x} 0\t{path}"
                for index, path in enumerate(pointer_paths)
            )
        if args[:2] == ("status", "--short"):
            return f" M {pointer_paths[0]}\n" if dirty else ""
    ...
    monkeypatch.setattr(
        contract_module,
        "collect_dvc_pointer_records",
        lambda *_args, **_kwargs: pointer_records,
    )
    monkeypatch.setattr(
        precommit_artifacts,
        "run_command",
        lambda *_args, **_kwargs: (_ for _ in ()).throw(
            AssertionError("no subprocess command is allowed in the static boundary")
        ),
    )
    monkeypatch.setattr(
        precommit_artifacts.subprocess,
        "run",
        lambda *_args, **_kwargs: (_ for _ in ()).throw(
            AssertionError("no subprocess DVC command is allowed")
        ),
    )

    digest = precommit_artifacts._closure_phase4_cert_static_git_pointer_boundary(
        repo_root=Path("."),
        tree_lease=cast(Any, SimpleNamespace()),
    )
    assert re.fullmatch(r"[0-9a-f]{64}", digest)
    assert not hasattr(precommit_artifacts, "_closure_phase4_cert_dvc_status")
    assert not hasattr(
        precommit_artifacts,
    ...
    assert not hasattr(
        precommit_artifacts,
        "ClosurePhase4FinalCertificationDvcRuntimeLease",
    )
    assert not hasattr(
        precommit_artifacts,
    ...
    with pytest.raises(
        precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
        match="pointer Git state is not pristine",
    ):
        precommit_artifacts._closure_phase4_cert_static_git_pointer_boundary(
            repo_root=Path("."),
            tree_lease=cast(Any, SimpleNamespace()),
        )


def test_closure_phase4_cert_report_states_dvc_status_was_not_run(
    tmp_path: Path,
) -> None:
    report_path = tmp_path / "phase4-cert-precommit.md"
    precommit_artifacts.write_report(
        ...
        git_status_before="M  phase4-cert-file\n",
        ...
        reproducibility_findings=[
            precommit_artifacts.ReproducibilityFinding(
                ...
                "phase4_p_cert_dvc",
                "-",
                "DVC status was not executed.",
            )
        ],
        staged_status="A  phase4-cert-file\n",
    )

    report = report_path.read_text(encoding="utf-8")
    before_section = report.split("## DVC Status Before", 1)[1].split(
        "## DVC Status After Staging", 1
    )[0]
    after_section = report.split("## DVC Status After Staging", 1)[1].split(
        "## DVC Cloud Status Before Push", 1
    )[0]
    assert before_section.strip() == "Not run."
    assert after_section.strip() == "Not run."
    assert "DVC status was not executed." in report
    assert "```json\n{}\n```" not in report
...
def test_closure_phase4_cert_runner_stages_only_exact_scope_without_execution(
    gate: str, monkeypatch, capsys
) -> None:
    state = _install_phase4_cert_runner_harness(monkeypatch, gate=gate)
    report: dict[str, Any] = {}
    monkeypatch.setattr(
        precommit_artifacts,
        "write_report",
        lambda *_args, **kwargs: report.update(kwargs),
    )
    monkeypatch.setattr(
        precommit_artifacts,
        "dvc_status_json",
        lambda *_args, **_kwargs: (_ for _ in ()).throw(
            AssertionError("Phase 4 certification precommit must not invoke DVC")
        ),
    )
    monkeypatch.setattr(
        precommit_artifacts,
        "_initialize_precommit_dvc_observation",
        lambda *_args, **_kwargs: (_ for _ in ()).throw(
            AssertionError("Phase 4 certification precommit must not initialize DVC")
        ),
    )
    monkeypatch.setattr(
        precommit_artifacts.subprocess,
        "run",
        lambda *_args, **_kwargs: (_ for _ in ()).throw(
            AssertionError("Phase 4 certification precommit launched a subprocess")
        ),
    )
    args = _closure_phase3_h_args()
    initial = _phase4_cert_short_status(gate, staged=False)
    assert (
    ...
    assert state["commands"] == [
        [
            ...
            "-A",
            "--",
            *sorted(precommit_artifacts._closure_phase4_cert_scope(gate)),
        ]
    ]
    assert report["dvc_status_before"] is None
    assert report["dvc_status_after"] is None
    assert any(
        "DVC status was not executed" in finding.message
        for finding in report["reproducibility_findings"]
    )
    assert "no certification or DVC command ran" in capsys.readouterr().out
...
def test_closure_phase4_cert_runner_rolls_back_on_post_add_pointer_drift(
    monkeypatch,
) -> None:
    state = _install_phase4_cert_runner_harness(monkeypatch)
    calls = 0

    def boundary(*_args: Any, **_kwargs: Any) -> str:
        nonlocal calls
        calls += 1
        return "static-boundary" if calls <= 2 else "changed-boundary"
...
def test_closure_phase4_r_cert_delegates_mutated_report_to_custom_validator(
    ...
    dvc_status_policy = contract_module.expected_dvc_status_policy(
        cast(contract_module.FinalCertificationContract, contract)
    )
    ...
    monkeypatch.setattr(
        ...
        lambda *_args, **_kwargs: {
            "p_cert_commit": head,
            "h_cert_commit": "b" * 40,
            "p21_cert_commit": head,
            "h21_cert_commit": "b" * 40,
            "p20_cert_commit": precommit_artifacts.CLOSURE_PHASE4_P_CERT_V20_COMMIT,
            "h20_cert_commit": precommit_artifacts.CLOSURE_PHASE4_H_CERT_V20_COMMIT,
            "p19_cert_commit": None,
            "h19_cert_commit": (
            ...
            "h3_cert_commit": (
                precommit_artifacts.CLOSURE_PHASE4_H_CERT_V3_COMMIT
            ),
            "p2_cert_commit": (
                precommit_artifacts.CLOSURE_PHASE4_P_CERT_V2_COMMIT
            ),
...
def _phase4_r_cert_adapter_payloads() -> tuple[Any, dict[str, Any], list[Any], list[Any], dict[str, Any]]:
    ...
    contract = SimpleNamespace(
        ...
        dvc_pointers=specs,
        dvc_pointer_paths=tuple(spec.path for spec in specs),
        post_restore_status_pointer_paths=tuple(spec.path for spec in specs),
        post_verification_status_pointer_paths=tuple(spec.path for spec in specs),
    )
    dvc_status_policy = contract_module.expected_dvc_status_policy(
        cast(contract_module.FinalCertificationContract, contract)
    )
    ...
    manifest = {
        ...
        "p_cert_authority": {
            ...
            "p21_cert_commit": head,
            "h21_cert_commit": effective["h21_cert_commit"],
            "p20_cert_commit": effective["p20_cert_commit"],
            "h20_cert_commit": effective["h20_cert_commit"],
            "p19_cert_commit": None,
            "h19_cert_commit": effective["h19_cert_commit"],
            "p18_cert_commit": effective["p18_cert_commit"],
            "h18_cert_commit": effective["h18_cert_commit"],
            "p17_cert_commit": effective["p17_cert_commit"],
            "h17_cert_commit": effective["h17_cert_commit"],
            "p16_cert_commit": effective["p16_cert_commit"],
            "h16_cert_commit": effective["h16_cert_commit"],
            "p15_cert_commit": effective["p15_cert_commit"],
            "h15_cert_commit": effective["h15_cert_commit"],
            "p14_cert_commit": effective["p14_cert_commit"],
            "h14_cert_commit": effective["h14_cert_commit"],
            "p12_cert_commit": effective["p12_cert_commit"],
            "h12_cert_commit": effective["h12_cert_commit"],
            "p11_cert_commit": effective["p11_cert_commit"],
            "h11_cert_commit": effective["h11_cert_commit"],
            "p10_cert_commit": effective["p10_cert_commit"],
            ...
            "p7_cert_commit": effective["p7_cert_commit"],
            "h7_cert_commit": effective["h7_cert_commit"],
            "p6_cert_commit": effective["p6_cert_commit"],
            "h6_cert_commit": effective["h6_cert_commit"],
            "p5_cert_commit": effective["p5_cert_commit"],
            "h5_cert_commit": effective["h5_cert_commit"],
            "p4_cert_commit": effective["p4_cert_commit"],
            "h4_cert_commit": effective["h4_cert_commit"],
            "p3_cert_commit": effective["p3_cert_commit"],
...
def _phase4_r_cert_real_builder_payloads() -> tuple[
    Any,
    dict[str, Any],
    list[Any],
    list[Any],
    ...
    """Return one producer-built R payload plus its synthetic external inputs."""

    from tests import test_build_phase4_final_certification as builder_tests

    contract = builder_tests._locked_contract()
    products = builder_tests._products(contract)
    authority = builder_tests._authority(contract)
    effective = deepcopy(authority)
    effective["authority_bytes"] = b"a" * cast(int, authority["authority_bytes"])
    effective["manifest_bytes"] = b"b" * cast(int, authority["manifest_bytes"])
    anchors = builder_tests._anchor_records(contract)
    pointers = builder_tests._pointer_records(contract)
    return contract, effective, anchors, pointers, products, authority
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            lambda value: value["clone"]["sandbox_mountpoints"].__setitem__(
                "required_mode", "0755"
            ),
            "authority/anchor/pointer",
        ),
        (
            lambda value: value["verification"]["sandbox_smoke"].__setitem__(
...
def test_closure_phase4_r_cert_positive_path_binds_split_authority_and_clone_exactly(
    ...
    (
        ...
        real_products,
        real_authority,
    ) = _phase4_r_cert_real_builder_payloads()
    real_head = real_effective["p_cert_commit"]
    real_manifest_bytes = contract_module.canonical_json_bytes(
        real_products.manifest
    )

    def real_read(path: str, **_kwargs: Any) -> bytes:
        if path == real_contract.output_paths[-1]:
            return real_manifest_bytes
        return real_products.artifacts[Path(path).name]

    with monkeypatch.context() as real_patch:
        real_patch.setattr(
            precommit_artifacts,
            "_require_closure_phase4_cert_contract",
            lambda **_kwargs: real_contract,
        )
        real_patch.setattr(
            precommit_artifacts,
            "_git_output",
            lambda *_args: real_head,
        )
        real_patch.setattr(
            precommit_artifacts,
            "_require_closure_phase4_published_p_cert",
            lambda *_args, **_kwargs: real_effective["h_cert_commit"],
        )
        real_patch.setattr(
            precommit_artifacts,
            "_require_closure_phase4_r_cert_namespace_exact",
        ...
        real_patch.setattr(
            contract_module,
            "load_effective_authority",
            lambda *_args, **_kwargs: real_effective,
        )
        real_patch.setattr(
            contract_module,
            "collect_anchor_input_records",
            lambda *_args, **_kwargs: real_anchors,
        )
        real_patch.setattr(
            contract_module,
            "collect_dvc_pointer_records",
            lambda *_args, **_kwargs: real_pointers,
        )
        real_patch.setattr(
            builder,
            "_authority_loader",
            lambda *_args, **_kwargs: real_authority,
        )
        real_patch.setattr(
            builder,
            "collect_anchor_input_records",
        ...
        assert "public_junit_redaction_policy" not in real_products.manifest[
            "verification"
        ]["sandbox"]
        assert "public_junit_redaction_policy" not in json.loads(
            real_products.artifacts["environment.json"]
        )["isolation"]
        real_digest = precommit_artifacts._closure_phase4_cert_semantic_digest(
            "R-CERT", repo_root=Path(".")
        )
        assert re.fullmatch(r"[0-9a-f]{64}", real_digest)

        third_projection = deepcopy(dict(real_products.manifest))
        third_projection["verification"]["sandbox"][
            "public_junit_redaction_policy"
        ] = contract_module.expected_public_junit_redaction_policy()
        third_projection_bytes = contract_module.canonical_json_bytes(
            third_projection
        )
        real_patch.setattr(
            precommit_artifacts,
            "_read_closure_phase4_cert_file",
            lambda path, **_kwargs: (
                third_projection_bytes
                if path == real_contract.output_paths[-1]
                else real_products.artifacts[Path(path).name]
            ),
        )
        with pytest.raises(
            precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
            match="verification sandbox record is not exact",
        ):
            precommit_artifacts._closure_phase4_cert_semantic_digest(
                "R-CERT", repo_root=Path(".")
            )

        delegated_sandbox_drifts = (
            ("cleanup_diagnostic_policy", "raw_stderr_serialized", True),
            (
                "postgres_connection_policy",
                "test_database_url_query_present",
                True,
            ),
            (
                "postgres_startup_stability_policy",
                "pid1_checked_before_readiness",
                False,
            ),
        )
        for policy_name, field, value in delegated_sandbox_drifts:
            drifted = deepcopy(dict(real_products.manifest))
            drifted["verification"]["sandbox"][policy_name][field] = value
            drifted_bytes = contract_module.canonical_json_bytes(drifted)
            real_patch.setattr(
                precommit_artifacts,
                "_read_closure_phase4_cert_file",
                lambda path, *, payload=drifted_bytes, **_kwargs: (
                    payload
                    if path == real_contract.output_paths[-1]
                    else real_products.artifacts[Path(path).name]
                ),
            ...
            with pytest.raises(
                precommit_artifacts.ClosurePhase4FinalCertificationPrecommitAdapterError,
                match="verification sandbox controls drifted",
            ):
                precommit_artifacts._closure_phase4_cert_semantic_digest(
                    "R-CERT", repo_root=Path(".")
                )
    ...
    # The producer/validator integration above remains real.  This narrow stub
    # isolates the adapter-owned authority and clone bindings exercised by the
    # historical parametrization without fabricating a third policy copy.
    def validate(*, manifest: Mapping[str, Any], **_kwargs: Any) -> None:
        nonlocal validator_calls
        validator_calls += 1
        if manifest.get("verification", {}).get("sandbox_smoke") != {
            "status": "passed",
            **contract_module.expected_sandbox_smoke_policy(),
        }:
            raise builder.FinalCertificationBuildError(
                "R-CERT authority/anchor/pointer verification drifted"
            )
...
def test_closure_phase4_cert_adapter_source_has_no_execution_or_mutation_calls() -> None:
    ...
    assert "dvc_status_json" not in source
    assert "_initialize_precommit_dvc_observation" not in source
    assert "_closure_phase4_cert_dvc_status" not in source
    assert "DEFAULT_DVC_BIN" not in source
    assert "_closure_phase4_cert_static_git_pointer_boundary(" in source
    assert "_closure_phase4_cert_static_git_pointer_boundary(" in rollback
